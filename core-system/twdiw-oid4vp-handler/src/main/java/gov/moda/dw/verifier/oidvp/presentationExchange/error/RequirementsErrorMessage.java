...
public class RequirementsErrorMessage extends PresentationError {
  ...
  //    public RequirementsErrorMessage(int currentIndex, List<Integer> trace, List<CountErrorInfo>
  // countErrorInfo) {
  ...
  public RequirementsErrorMessage(
      Deque<Integer> traceDeque, int currentIndex, List<CountErrorInfo> countErrorInfo) {
  ...
  private String getErrorTraceDescription(Deque<Integer> traceDeque, int currentIndex) {
    if (traceDeque.isEmpty()) {
      ...
      StringBuilder sb =
          new StringBuilder("submission_requirement[" + traceDeque.pollFirst() + "]");
  ...
  private String getErrorDescription(
      Deque<Integer> traceDeque, int currentIndex, List<CountErrorInfo> errors) {
    ...
    while (iterator.hasNext()) {
      ...
      sb.append("(");
      sb.append("from=")
          .append(Optional.ofNullable(error.group()).orElse("from_nested"))
          .append(",");
