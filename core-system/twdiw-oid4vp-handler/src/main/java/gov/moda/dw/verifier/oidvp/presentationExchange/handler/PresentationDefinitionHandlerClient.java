...
public class PresentationDefinitionHandlerClient {
  ...
  private static final Logger LOGGER =
      LoggerFactory.getLogger(PresentationDefinitionHandlerClient.class);
  ...
  public PresentationDefinitionHandlerResult evaluate(
  ...
  private PresentationDefinitionHandler initHandler() {
    ...
    handler
        .setNextHandler(new InputDescriptorFieldHandler(this))
