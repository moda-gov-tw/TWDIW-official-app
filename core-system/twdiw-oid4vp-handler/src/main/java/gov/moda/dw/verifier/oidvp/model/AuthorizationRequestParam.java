...
public class AuthorizationRequestParam extends RequestParam {
  ...
  /**
   * when response_mode is 'direct_post' or 'direct_post.jwt' will use this uri to set
   * 'response_uri', otherwise will use this uri to set 'redirect_uri'
   */
  ...
  public AuthorizationRequestParam(
      URI authorizationEndpoint, ResponseType responseType4VP, Nonce nonce) {
  ...
  public AuthorizationRequestParam setPresentationDefinitionParameter(
      PresentationDefinitionParameter presentationDefinitionParameter) {
