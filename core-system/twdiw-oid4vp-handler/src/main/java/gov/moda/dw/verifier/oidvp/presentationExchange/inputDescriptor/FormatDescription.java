...
public class FormatDescription {
  ...
  private FormatDescription(
      HashSet<JwtAlgValue> alg,
      HashSet<LdpProofType> proofType,
      HashSet<JwtAlgValue> sdJwtAlgValues,
      HashSet<JwtAlgValue> kbJwtAlgValues) {
    this.alg = alg;
  ...
  public static FormatDescription sdJwtAlgAndKbJwtAlg(
      HashSet<JwtAlgValue> sdJwtAlgValues, HashSet<JwtAlgValue> kbJwtAlgValues) {
  ...
  public static class LdpProofType extends FormatAlgorithm {
    ...
    public static final LdpProofType Ed25519Signature2018 =
        new LdpProofType("Ed25519Signature2018");
    public static final LdpProofType RsaSignature2018 = new LdpProofType("RsaSignature2018");
    public static final LdpProofType EcdsaSecp256k1Signature2019 =
        new LdpProofType("EcdsaSecp256k1Signature2019");
    public static final LdpProofType EcdsaSecp256k1RecoverySignature2020 =
        new LdpProofType("EcdsaSecp256k1RecoverySignature2020");
    public static final LdpProofType JsonWebSignature2020 =
        new LdpProofType("JsonWebSignature2020");
    public static final LdpProofType GpgSignature2020 = new LdpProofType("GpgSignature2020");
    public static final LdpProofType JcsEd25519Signature2020 =
        new LdpProofType("JcsEd25519Signature2020");
