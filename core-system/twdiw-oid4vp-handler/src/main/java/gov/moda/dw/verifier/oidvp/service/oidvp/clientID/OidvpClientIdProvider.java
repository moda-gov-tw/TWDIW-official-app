...
public interface OidvpClientIdProvider {
  ...
  /**
   * oidvp client_id={@code <client_id_scheme>:<orig_client_id>} <br>
  ...
  /**
   * get the jwk for signing the Authorization Request correspond to this client_id, if the
   * client_id_scheme were able to sign the Authorization Request
   *
   * @return JWK
   */
  JWK getSigningJWK();
