        ...
        .authorizeHttpRequests(
            authz ->
                ...
                authz
                    ...
                    .requestMatchers(mvc.pattern("/api/oidvp/**"))
                    .permitAll() // oid4vp api
                    //
                    // .requestMatchers(mvc.pattern("/api/oidvp/**")).authenticated()  // oid4vp api
                    //
            ...
            //                    .requestMatchers(mvc.pattern("/test-sp/**")).permitAll()  // test
            // sp page
