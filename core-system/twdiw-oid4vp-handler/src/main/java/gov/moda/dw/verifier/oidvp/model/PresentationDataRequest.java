...
public class PresentationDataRequest {
  ...
  public String toString() {
    ...
    sb.append("\"business_id\":\"").append(businessId).append('\"');

    sb.append(",\"serial_no\":\"").append(serialNo).append('\"');

    sb.append(",\"mode\":\"").append(mode).append('\"');

    sb.append(",\"presentation_definition\":").append(presentationDefinition);
