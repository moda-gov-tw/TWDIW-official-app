...
public class VcResponseObjectDTO {
  ...
  public static List<VcResponseObjectDTO> toVcResponseObjectDTOs(
      PresentationDefinitionHandlerResult presentationDefinitionResult) {
    if (presentationDefinitionResult == null
        || presentationDefinitionResult.getClaimInfos() == null) {
      return null;
    }
