...
public class VerifyResultDao {
  ...
  public VerifyResultJpa getVerifyResultNotExpired(String transactionId, int aliveTime)
      throws SQLException {
    ...
    if (now.isBefore(expiredTime)) {
      ...
      throw new OidvpRuntimeException(
          OidvpError.INVALID_SESSION, "verifyResult transaction is expired");
    }
  }

  public VerifyResultJpa getVerifyResultNotExpiredByResponseCode(String responseCode, int aliveTime)
      throws SQLException {
  ...
  public VerifyResultJpa updateSessionAndSaveResult(
  ...
  private VerifyResultJpa saveVerifyResult(
      SessionJpa session, String responseCode, VerifyResult verifyResult) throws SQLException {
    ...
    try {
      ...
      if (e.getMessage().toLowerCase().contains("duplicate")) {
        ...
        throw new OidvpRuntimeException(
            OidvpError.INVALID_SESSION, "the session has been validated");
      } else {
