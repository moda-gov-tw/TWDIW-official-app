...
public class OidvpResponse extends Response {
  ...
  public static OidvpResponse success(
      String transactionId, String qrCode, URI authUri, Integer expiredIn) {
    OidvpResponse response = new OidvpResponse();
    response.setTransactionId(transactionId);
    response.setQrCodeImage(qrCode);
    response.setAuthUri(authUri.toString());
  ...
  public String toString() {
    ...
    if (authUri != null) {
      sb.append("\"authUri\":\"").append(authUri).append('\"');
    }
    if (transactionId != null) {
      sb.append(",\"transactionId\":\"").append(transactionId).append('\"');
    }
    if (qrCodeImage != null) {
      sb.append(",\"qrCodeImage\":\"").append(qrCodeImage).append('\"');
    }
    if (code != null) {
    ...
    if (expiredIn != null) {
      sb.append(",\"expiredIn\":\"").append(message).append('\"');
    }
    sb.append("}");
