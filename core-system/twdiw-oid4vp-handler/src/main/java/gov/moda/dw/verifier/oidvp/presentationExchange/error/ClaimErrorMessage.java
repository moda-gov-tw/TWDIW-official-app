...
public class ClaimErrorMessage extends PresentationError {
  ...
  public static final String EVALUATION_MESSAGE_FORMAT =
      "(claim_name=%s, input_descriptor_id=%s, type=%s)";
  ...
  public ClaimErrorMessage(
      ErrorType type, String requiredClaimName, String inputDescriptorId, String vcType) {
    this.type = type;
