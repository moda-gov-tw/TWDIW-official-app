...
public class OidvpErrorCode {
  ...
  public static final String MSG_CREDENTIAL_NUMBER_NOT_MATCH =
      "the number of credential is not match to the presentation_submission";
  ...
  public static final String MSG_VC_NOT_MATCH_PRESENTATION_DEFINITION =
      "vc is not meet the criteria in the presentation_definition";
  public static final String MSG_PS_NOT_MATCH_PD =
      "presentation_submission is not matched presentation_definition";
  public static final String MSG_VC_CLAIM_NOT_MATCH_FILTER =
      "vc claim is not matched the requirement of filter";
  public static final String MSG_CLAIM_NOT_FOUND = "can not find required claim in vc";
  public static final String MSG_INPUT_DESCRIPTORS_ID_NOT_UNIQUE =
      "input_descriptors's id is not unique";
  public static final String MSG_INVALID_PRESENTATION_DEFINITION =
      "invalid presentation_definition";
  public static final String MSG_INVALID_PRESENTATION_SUBMISSION =
      "invalid presentation_submission";
  public static final String MSG_VC_NOT_MATCH_PRESENTATION_SUBMISSION =
      "vc and presentation_submission do not match";
  ...
  public static final String MSG_VC_NOT_SUPPORT_LIMIT_DISCLOSURE =
      "vc is not support limit_disclosure";
  ...
  public static final String MSG_CALL_FRONTEND_GENERATE_DID_ERROR =
      "call frontend service generate DID fail";
  public static final String MSG_CALL_FRONTEND_REGISTER_DID_ERROR =
      "call frontend service register DID fail";
  public static final String MSG_CALL_FRONTEND_REVIEW_DID_ERROR =
      "call frontend service review DID fail";
  ...
  public static final String MSG_CALL_FRONTEND_CREATE_DID_ERROR =
      "call frontend service create DID fail";

  public static final String MSG_CALL_VERIFIER_BUSINESS_CALLBACK_ERROR =
      "call verifier business callback fail";
  public static final String MSG_VERIFIER_BUSINESS_CALLBACK_RESPONSE_ERROR =
      "verifier business callback response error";
  ...
  public enum OidvpError {
    ...
    SIGN_REQUEST_OBJECT_ERROR(
        CODE_SIGN_REQUEST_OBJECT_ERROR,
        MSG_SIGN_REQUEST_OBJECT_ERROR,
        HttpStatus.INTERNAL_SERVER_ERROR),

    JSON_PROCESS_ERROR(
        CODE_JSON_PROCESS_ERROR, MSG_JSON_PROCESS_ERROR, HttpStatus.INTERNAL_SERVER_ERROR),

    GEN_QRCODE_ERROR(CODE_GEN_QRCODE_ERROR, MSG_GEN_QRCODE_ERROR, HttpStatus.INTERNAL_SERVER_ERROR),

    AUTHZ_RESPONSE_ERROR(
        CODE_AUTHZ_RESPONSE_ERROR, MSG_AUTHZ_RESPONSE_ERROR, HttpStatus.BAD_REQUEST),
    ...
    CREDENTIAL_NUMBER_NOT_MATCH(
        CODE_CREDENTIAL_NUMBER_NOT_MATCH, MSG_CREDENTIAL_NUMBER_NOT_MATCH, HttpStatus.BAD_REQUEST),

    ID_NONCE_NOT_MATCH(CODE_ID_NONCE_NOT_MATCH, MSG_ID_NONCE_NOT_MATCH, HttpStatus.BAD_REQUEST),

    VC_NOT_MATCH_PRESENTATION_DEFINITION(
        CODE_VC_NOT_MATCH_PRESENTATION_DEFINITION,
        MSG_VC_NOT_MATCH_PRESENTATION_DEFINITION,
        HttpStatus.BAD_REQUEST),

    PS_NOT_MATCH_PD(CODE_PS_NOT_MATCH_PD, MSG_PS_NOT_MATCH_PD, HttpStatus.BAD_REQUEST),

    VC_CLAIM_NOT_MATCH_FILTER(
        CODE_VC_CLAIM_NOT_MATCH_FILTER, MSG_VC_CLAIM_NOT_MATCH_FILTER, HttpStatus.BAD_REQUEST),

    CLAIM_NOT_FOUND(CODE_CLAIM_NOT_FOUND, MSG_CLAIM_NOT_FOUND, HttpStatus.BAD_REQUEST),

    INPUT_DESCRIPTORS_ID_NOT_UNIQUE(
        CODE_INPUT_DESCRIPTORS_ID_NOT_UNIQUE,
        MSG_INPUT_DESCRIPTORS_ID_NOT_UNIQUE,
        HttpStatus.BAD_REQUEST),

    INVALID_PRESENTATION_DEFINITION(
        CODE_INVALID_PRESENTATION_DEFINITION,
        MSG_INVALID_PRESENTATION_DEFINITION,
        HttpStatus.BAD_REQUEST),

    INVALID_PRESENTATION_SUBMISSION(
        CODE_INVALID_PRESENTATION_SUBMISSION,
        MSG_INVALID_PRESENTATION_SUBMISSION,
        HttpStatus.BAD_REQUEST),

    VC_NOT_MATCH_PRESENTATION_SUBMISSION(
        CODE_VC_NOT_MATCH_PRESENTATION_SUBMISSION,
        MSG_VC_NOT_MATCH_PRESENTATION_SUBMISSION,
        HttpStatus.BAD_REQUEST),

    INVALID_SUBMISSION_REQUIREMENT(
        CODE_INVALID_SUBMISSION_REQUIREMENT,
        MSG_INVALID_SUBMISSION_REQUIREMENT,
        HttpStatus.BAD_REQUEST),
    ...
    VC_NOT_SUPPORT_LIMIT_DISCLOSURE(
        CODE_VC_NOT_SUPPORT_LIMIT_DISCLOSURE,
        MSG_VC_NOT_SUPPORT_LIMIT_DISCLOSURE,
        HttpStatus.BAD_REQUEST),

    INVALID_SESSION(CODE_INVALID_SESSION, MSG_INVALID_SESSION, HttpStatus.BAD_REQUEST),

    VP_RESPONSE_ERROR(
        CODE_VP_RESPONSE_ERROR, MSG_VP_RESPONSE_ERROR, HttpStatus.INTERNAL_SERVER_ERROR),

    VERIFY_FAIL(CODE_VERIFY_FAIL, MSG_VERIFY_FAIL, HttpStatus.INTERNAL_SERVER_ERROR),

    JWK_STORE_OPERATION_ERROR(
        CODE_JWK_STORE_OPERATION_ERROR,
        MSG_JWK_STORE_OPERATION_ERROR,
        HttpStatus.INTERNAL_SERVER_ERROR),

    CALL_FRONTEND_GENERATE_DID_ERROR(
        CODE_CALL_FRONTEND_GENERATE_DID_ERROR,
        MSG_CALL_FRONTEND_GENERATE_DID_ERROR,
        HttpStatus.INTERNAL_SERVER_ERROR),

    CALL_FRONTEND_REGISTER_DID_ERROR(
        CODE_CALL_FRONTEND_REGISTER_DID_ERROR,
        MSG_CALL_FRONTEND_REGISTER_DID_ERROR,
        HttpStatus.INTERNAL_SERVER_ERROR),

    CALL_FRONTEND_REVIEW_DID_ERROR(
        CODE_CALL_FRONTEND_REVIEW_DID_ERROR,
        MSG_CALL_FRONTEND_REVIEW_DID_ERROR,
        HttpStatus.INTERNAL_SERVER_ERROR),

    SIGN_DID_DOCUMENT_ERROR(
        CODE_SIGN_DID_DOCUMENT_ERROR,
        MSG_SIGN_DID_DOCUMENT_ERROR,
        HttpStatus.INTERNAL_SERVER_ERROR),

    PARSE_DID_FROM_DOCUMENT_ERROR(
        CODE_PARSE_DID_FROM_DOCUMENT_ERROR,
        MSG_PARSE_DID_FROM_DOCUMENT_ERROR,
        HttpStatus.INTERNAL_SERVER_ERROR),

    GET_DID_ERROR(CODE_GET_DID_ERROR, MSG_GET_DID_ERROR, HttpStatus.INTERNAL_SERVER_ERROR),

    GENERATE_KEY_ERROR(
        CODE_GENERATE_KEY_ERROR, MSG_GENERATE_KEY_ERROR, HttpStatus.INTERNAL_SERVER_ERROR),

    CALL_VP_SERVICE_ERROR(
        CODE_CALL_VP_SERVICE_ERROR, MSG_CALL_VP_SERVICE_ERROR, HttpStatus.INTERNAL_SERVER_ERROR),

    REGISTER_DID_ERROR(
        CODE_REGISTER_DID_ERROR, MSG_REGISTER_DID_ERROR, HttpStatus.INTERNAL_SERVER_ERROR),

    GET_METADATA_ERROR(
        CODE_GET_METADATA_ERROR, MSG_GET_METADATA_ERROR, HttpStatus.INTERNAL_SERVER_ERROR),

    PARSE_DID_ERROR(CODE_PARSE_DID_ERROR, MSG_PARSE_DID_ERROR, HttpStatus.INTERNAL_SERVER_ERROR),

    OIDVP_CLIENT_ID_NOT_MATCH_ERROR(
        CODE_OIDVP_CLIENT_ID_NOT_MATCH_ERROR,
        MSG_OIDVP_CLIENT_ID_NOT_MATCH_ERROR,
        HttpStatus.INTERNAL_SERVER_ERROR),

    CALL_FRONTEND_CREATE_DID_ERROR(
        CODE_CALL_FRONTEND_CREATE_DID_ERROR,
        MSG_CALL_FRONTEND_CREATE_DID_ERROR,
        HttpStatus.INTERNAL_SERVER_ERROR),

    CALL_VERIFIER_BUSINESS_CALLBACK_ERROR(
        CODE_CALL_VERIFIER_BUSINESS_CALLBACK_ERROR,
        MSG_CALL_VERIFIER_BUSINESS_CALLBACK_ERROR,
        HttpStatus.INTERNAL_SERVER_ERROR),

    VERIFIER_BUSINESS_CALLBACK_RESPONSE_ERROR(
        CODE_VERIFIER_BUSINESS_CALLBACK_RESPONSE_ERROR,
        MSG_VERIFIER_BUSINESS_CALLBACK_RESPONSE_ERROR,
        HttpStatus.INTERNAL_SERVER_ERROR),
