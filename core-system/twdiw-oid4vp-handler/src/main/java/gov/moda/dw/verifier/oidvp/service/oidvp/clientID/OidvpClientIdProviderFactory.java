...
public interface OidvpClientIdProviderFactory {
   ...
   * @param responseMode response_mode. If client_id_scheme is 'redirect_uri' this parameter must be
   *     specified, otherwise it can be null.
   * @return OidvpClientIdProvider for specified ClientIdScheme
   */
  OidvpClientIdProvider createClientIdProvider(
