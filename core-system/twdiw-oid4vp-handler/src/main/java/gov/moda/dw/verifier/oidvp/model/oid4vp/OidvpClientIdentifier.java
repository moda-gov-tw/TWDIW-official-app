...
public class OidvpClientIdentifier {
  ...
  public OidvpClientIdentifier(ClientIdScheme clientIdScheme, ClientID originalClientID) {
    this.clientIdScheme =
        Objects.requireNonNull(clientIdScheme, "clientIdScheme must be specified");
  ...
  private ClientID setAndCheckOriginalClientID(
      ClientIdScheme clientIdScheme, ClientID originalClientID) {
    ...
    try {
      switch (clientIdScheme) {
        ...
        default -> throw new UnsupportedOperationException(
            "client_id_scheme: " + clientIdScheme + " is unsupported.");
      }
    } catch (IllegalArgumentException e) {
      throw new BadOidvpParamException(
          "invalid orig_client_id format for client_id_scheme=" + clientIdScheme);
    }
    return originalClientID;
  }
