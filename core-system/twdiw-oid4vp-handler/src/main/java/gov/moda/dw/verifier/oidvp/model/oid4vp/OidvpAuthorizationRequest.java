...
public class OidvpAuthorizationRequest extends AuthorizationRequest {
  ...
  /**
   * The required maximum authentication age, in seconds, -1 if not specified, zero implies
  ...
  /**
   * Previously issued ID Token passed to the authorisation server as a hint about the end-user's
   * current or past authenticated session with the client (optional). Should be present when {@code
   * prompt=none} is used.
   */
  private final JWT idTokenHint;

  /**
   * Hint to the authorisation server about the login identifier the end-user may use to log in
   * (optional).
   */
  ...
  private OidvpAuthorizationRequest(
      URI uri,
      ResponseType rt,
      ResponseMode rm,
      Scope scope,
    ...
    if (!specifiesRequestObject()) {
      ...
      if (redirectURI != null && responseURI != null) {
        throw new IllegalArgumentException(
            "The redirect_uri and response_uri can not present at the same time");
      }

      if (OidvpResponseMode.DIRECT_POST.equals(rm) && responseURI == null) {
        throw new IllegalArgumentException(
            "response_uri must be present when the response_mode is direct_post");
      }

      if (presentationDefinition == null && presentationDefinitionURI == null && scope == null) {
        throw new IllegalArgumentException(
            "presentation_definition or presentation_definition_uri or scope must be specified");
      }

      if (presentationDefinition != null && presentationDefinitionURI != null) {
        throw new IllegalArgumentException(
            "presentation_definition and presentation_definition_uri can not present at the same time");
      }
  ...
  public static class Builder {
    ...
    /**
     * Previously issued ID Token passed to the authorisation server as a hint about the end-user's
     * current or past authenticated session with the client (optional). Should be present when
     * {@code prompt=none} is used.
     */
     ...
     * @return This builder.
     */
    public OidvpAuthorizationRequest.Builder dPoPJWKThumbprintConfirmation(
        JWKThumbprintConfirmation dpopJKT) {
    ...
    /**
     * Sets the OpenID Connect Federation 1.0 trust chain. Corresponds to the optional {@code
    ...
    /**
     * Sets the required maximum authentication age. Corresponds to the optional {@code max_age}
     * parameter.
     *
    ...
    /**
     * Sets the end-user's preferred languages and scripts for the user interface, ordered by
     * preference. Corresponds to the optional {@code ui_locales} parameter.
     *
    ...
    /**
     * Sets the end-user's preferred languages and scripts for the claims being returned, ordered by
     * preference. Corresponds to the optional {@code claims_locales} parameter.
     *
    ...
    /**
     * Sets the ID Token hint. Corresponds to the conditionally optional {@code id_token_hint}
     * parameter.
     *
    ...
    /**
     * Sets the individual claims to be returned. Corresponds to the optional {@code claims}
     * parameter.
     *
    ...
    /**
     * Sets the individual OpenID claims to be returned. Corresponds to the optional {@code claims}
     * parameter.
     *
    ...
    /**
     * Sets the request object. Corresponds to the optional {@code request} parameter. Must not be
    ...
    /**
     * Sets the request object URI. Corresponds to the optional {@code request_uri} parameter. Must
     * not be specified together with a request object.
     *
    ...
    /**
     * Sets the response mode. Corresponds to the optional {@code response_mode} parameter. Use of
     * this parameter is not recommended unless a non-default response mode is requested (e.g.
     * form_post).
     *
     ...
     */
    @Deprecated
    public OidvpAuthorizationRequest.Builder codeChallenge(
     ...
     * Sets the code challenge for Proof Key for Code Exchange (PKCE) by public OAuth clients.
     *
     * @param codeVerifier The code verifier to use to compute the code challenge, {@code null} if
     *     PKCE is not specified.
     * @param codeChallengeMethod The code challenge method, {@code null} if not specified. Defaults
     *     to {@link CodeChallengeMethod#PLAIN} if a code verifier is specified.
     * @return This builder.
     */
    public OidvpAuthorizationRequest.Builder codeChallenge(
        CodeVerifier codeVerifier, CodeChallengeMethod codeChallengeMethod) {
     ...
     * @return This builder.
     */
    public OidvpAuthorizationRequest.Builder authorizationDetails(
        List<AuthorizationDetail> authorizationDetails) {
    ...
    /**
     * Sets the presentation_definition. Corresponds to the optional {@code presentation_definition}
     * parameter.This parameter MUST be present when presentation_definition_uri parameter is not
     * present.
     *
     * @param presentationDefinition The presentation_definition, {@code null} if not specified.
     * @return This builder.
     */
    public OidvpAuthorizationRequest.Builder presentationDefinition(
        PresentationDefinition presentationDefinition) {
    ...
    /**
     * Sets the presentation_definition_uri. Corresponds to the optional {@code
     * presentation_definition_uri} parameter.This parameter MUST be present when
     * presentation_definition parameter is not present.
     *
     * @param presentationDefinitionURI The presentation_definition_uri, {@code null} if not
     *     specified.
     * @return This builder.
     */
    public OidvpAuthorizationRequest.Builder presentationDefinitionURI(
        URI presentationDefinitionURI) {
    ...
    /**
     * Sets the client_metadata. Corresponds to the optional {@code client_metadata} parameter.It
     * MUST NOT be present if client_metadata_uri parameter is present.
     *
    ...
    /**
     * Sets the response_uri or redirect_uri. Corresponds to the optional {@code response_uri or
    ...
    /**
     * Sets the request_uri_method. Corresponds to the optional {@code request_uri_method}
     * parameter.
     *
     ...
     * @return This builder.
     */
    public OidvpAuthorizationRequest.Builder transactionData(
        List<TransactionData> transactionData) {
    ...
    public OidvpAuthorizationRequest build() {
      ...
      try {
        ...
        if (OID4VP.isUsingResponseURI(rm)) {
          ...
          customParameter(
              "response_uri",
              responseOrRedirectURI == null ? null : responseOrRedirectURI.toString());
        } else {
        ...
        if (getRequestObject() != null) {
          if (getRequestObject() instanceof JWSObject jwsObject) {
            if (JWSObject.State.SIGNED != jwsObject.getState()) {
              throw new BadOidvpParamException(
                  "the authorization request using client_id_scheme:"
                      + clientIdScheme.getValue()
                      + " must be signed, but the request object value has not been signed. (unsigned jwt)");
            }
            ...
            if (jwsObject == null || JWSObject.State.SIGNED != jwsObject.getState()) {
              throw new BadOidvpParamException(
                  "the authorization request using client_id_scheme:"
                      + clientIdScheme.getValue()
                      + " must be signed, but the request object value has not been signed. (jwe contains unsigned payload)");
            }
          } else {
            throw new BadOidvpParamException(
                "the authorization request using client_id_scheme:"
                    + clientIdScheme.getValue()
                    + " must be signed, but the request object value has not been signed. (plain jwt)");
          }
        } else if (getRequestURI() == null) {
          throw new BadOidvpParamException(
              "the authorization request using client_id_scheme:"
                  + clientIdScheme.getValue()
                  + " must be signed, but no request object value or reference was provided.");
        }
      }
    }
    return super.toURI();
  ...
  public JWTClaimsSet toJWTClaimsSet() {
    ...
    if (jwtClaimsSet.getClaim("presentation_definition") != null) {
      jwtClaimsSet =
          new JWTClaimsSet.Builder(jwtClaimsSet)
              .claim(
                  "presentation_definition",
                  JsonUtils.convertObjectToMap(getPresentationDefinition()))
              .build();
    }
