...
public class CustomDataValidator {
      ...
      try {
        ...
        jwsVerifier =
            new DefaultJWSVerifierFactory()
                .createJWSVerifier(customDataJWT.getHeader(), jwk.toECKey().toECPublicKey());
  ...
  public record CustomDataValidateResult(
      boolean validateResult, String errorMessage, CustomData customData) {
