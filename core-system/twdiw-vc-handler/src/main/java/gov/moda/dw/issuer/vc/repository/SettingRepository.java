...
public interface SettingRepository extends JpaRepository<Setting, String> {
  ...
  @Query(
      nativeQuery = true,
      value = "UPDATE setting SET prop_value = :prop_value WHERE prop_name = :prop_name")
  int updatePropValueByPropName(
      @Param("prop_name") String propName, @Param("prop_value") String propValue);
  ...
  @Query(
      nativeQuery = true,
      value =
          "UPDATE setting SET prop_value = CASE "
  ...
  int updateTwoPropValuesByPropName(
      @Param("prop_name_1") String propName1,
      @Param("prop_value_1") String propValue1,
      @Param("prop_name_2") String propName2,
      @Param("prop_value_2") String propValue2);
  ...
  @Query(
      nativeQuery = true,
      value = "SELECT * FROM setting WHERE prop_name IN (:prop_names) FOR UPDATE NOWAIT")
