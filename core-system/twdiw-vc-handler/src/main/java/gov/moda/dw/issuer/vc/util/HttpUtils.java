...
public class HttpUtils {
  ...
  private static void initializeWhiteMap() throws VcException {
    ...
    try {
      ...
      if (urlVpValidation != null
          && !urlVpValidation.isEmpty()
          && hostnameVpValidation != null
      ...
      if (urlDemoGetHolderData != null
          && !urlDemoGetHolderData.isEmpty()
          && hostnameDemoGetHolderData != null
      ...
      if (urlFrontendCreateDid != null
          && !urlFrontendCreateDid.isEmpty()
          && hostnameFrontendCreateDid != null
      ...
      if (urlFrontendGenerateDid != null
          && !urlFrontendGenerateDid.isEmpty()
          && hostnameFrontendGenerateDid != null
          && !hostnameFrontendGenerateDid.isEmpty()) {
      ...
      if (urlFrontendGetIssuerInfoDid != null
          && !urlFrontendGetIssuerInfoDid.isEmpty()
          && hostnameFrontendGetIssuerInfoDid != null
          && !hostnameFrontendGetIssuerInfoDid.isEmpty()) {
      ...
      if (urlFrontendRegisterDid != null
          && !urlFrontendRegisterDid.isEmpty()
          && hostnameFrontendRegisterDid != null
          && !hostnameFrontendRegisterDid.isEmpty()) {
      ...
      if (urlFrontendReviewDid != null
          && !urlFrontendReviewDid.isEmpty()
          && hostnameFrontendReviewDid != null
      ...
      if (urlVcBasePath != null
          && !urlVcBasePath.isEmpty()
          && hostnameVcBasePath != null
      ...
      if (urlOidvciQrcode != null
          && !urlOidvciQrcode.isEmpty()
          && hostnameOidvciQrcode != null
  ...
  public HttpUtils(Builder builder) {
    ...
    if (enableLog) {
      ...
      if (useProxy) {
        LOGGER.info(
            "Proxy 設定: {}://{}:{}", proxyServerProtocol, proxyServerAddress, proxyServerPort);
      } else {
  ...
  public Tuple.Pair<Integer, String> get() {
    ...
    try {
      ...
      // use "connection: close" to avoid SocketException (caused by too many open files) @
      // performance test
  ...
  public Tuple.Pair<Integer, String> postJson(String json) {
    return post(
        new StringEntity(json, StandardCharsets.UTF_8), ContentType.APPLICATION_JSON.toString());
  }
  ...
  //
  //        FormBodyPart formBodyPart = FormBodyPartBuilder.create("file", new
  // FileBody(file)).build();
  //
  ...
  private Tuple.Pair<Integer, String> post(HttpEntity entity, String contentType) {
    ...
    try {
      ...
      if (enableLog) {
        ...
        //                LOGGER.info("\nHTTP REQ {} {}\nHTTP REQ {} {}", symbol,
        // httpPost.getRequestLine(), symbol, EntityUtils.toString(entity));
      }
  ...
  private HttpRoutePlanner configHttpRoutePlanner() {
    ...
    return (target, request, context) -> {
      HttpHost proxy =
          useProxy ? new HttpHost(proxyServerAddress, proxyServerPort, proxyServerProtocol) : null;
      boolean isSecure = "https".equalsIgnoreCase(target.getSchemeName());
      RouteInfo.TunnelType tunnelType =
          useProxy ? RouteInfo.TunnelType.TUNNELLED : RouteInfo.TunnelType.PLAIN;
  ...
  private SSLConnectionSocketFactory configSSLConnectionSocketFactory()
      throws NoSuchAlgorithmException, KeyManagementException {
  ...
  public static class CustomizedTrustManager {
    ...
    private static final String KEY_STORE_NATIVE =
