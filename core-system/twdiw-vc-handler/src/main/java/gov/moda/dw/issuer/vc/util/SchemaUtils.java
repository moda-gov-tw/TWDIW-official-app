...
public class SchemaUtils {
  ...
  public static String generateSchema(String inputJson, String id, String title, String description)
      throws VcException {
  ...
  private static String addAdditionalAttributes(
      String schemaJson, String id, String title, String description) throws Exception {
