  ...
  public String start() throws VcException {
    ...
    try {
      ...
      JwtVerifiableCredential jwtVc =
          ToJwtConverter.toJwtVerifiableCredential(verifiableCredential);
      ...
      JWTClaimsSet jwtClaimsSet =
          new JWTClaimsSet.Builder(jwtVc.getPayload())
      ...
      return signJwt(byteSigner, jwtClaimsSet, null, publicKeysUri, kid);
