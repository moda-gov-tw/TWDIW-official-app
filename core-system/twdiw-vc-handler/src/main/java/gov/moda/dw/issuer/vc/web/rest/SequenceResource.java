...
public class SequenceResource {
  ...
  public ResponseEntity<String> addSeq(
      @PathVariable String credentialType, @RequestBody String sequenceRequestStr) {
    ...
    LOGGER.info(
        "[addSeq]::credentialType = {}, schemaId = {}, vcSchema = {}, effectiveTimeUnit = {}, effectiveTimeValue = {}, metadata = {}",
        credentialType,
        schemaId,
        vcSchema,
        effectiveTimeUnit,
    ...
    try {
      result =
          sequenceService.createSeqAndPolicyAndUpdateCredentialIssuerConfig(
              credentialType, 1, 1, sequenceRequest, sequenceRequestStr);
  ...
  public ResponseEntity<String> delSeq(
      @PathVariable String credentialType, @RequestBody SequenceDelRequestDTO sequenceDelRequest) {
    Tuple.Pair<String, HttpStatus> result = null;
    Map<String, Object> metadata = null;
    ...
    try {
      result =
          sequenceService.deleteSeqAndPolicyAndUpdateCredentialIssuerConfig(
              credentialType, sequenceDelRequest);
  ...
  public ResponseEntity<String> setFuncSwitch(
      @PathVariable String credentialType,
      @RequestBody FunctionSwitchRequestDTO functionSwitchRequest) {
    Tuple.Pair<String, HttpStatus> result = null;
