...
public class PublicInfoResource {
   ...
   */
  @GetMapping(
      path = "/status-list/{credentialType}/{groupName}",
      produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<String> getStatusList(
      @PathVariable String credentialType, @PathVariable String groupName) {
    ...
    Tuple.Pair<String, HttpStatus> result =
        publicInfoService.getStatusList(credentialType, cleanGroupName);
