...
public class StatusListResource {
  ...
  public ResponseEntity<String> generateAndRenew(
    ...
    LOGGER.info(
        ...
        statusListType,
        gid,
        Integer.parseInt(cleanGid));

    Tuple.Pair<String, HttpStatus> result =
        statusListService.generateAndRenew(
            credentialType, statusListType, Integer.parseInt(cleanGid));
