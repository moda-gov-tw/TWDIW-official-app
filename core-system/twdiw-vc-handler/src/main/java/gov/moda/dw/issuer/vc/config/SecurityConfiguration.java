...
public class SecurityConfiguration {
  ...
  public SecurityConfiguration(
      JHipsterProperties jHipsterProperties, UserDetailsService userDetailsService /*,
  ...
  public SecurityFilterChain filterChain(HttpSecurity http, MvcRequestMatcher.Builder mvc)
        ...
        .authorizeHttpRequests(
            authz ->
                ...
                authz
                    ...
                    // DID registration
                    .requestMatchers(mvc.pattern(HttpMethod.POST, "/api/did"))
                    .permitAll()
                    //                    .requestMatchers(mvc.pattern(HttpMethod.POST,
                    // "/api/did")).authenticated()

                    // credential
                    .requestMatchers(mvc.pattern(HttpMethod.POST, "/api/credential"))
                    .permitAll()
                    .requestMatchers(mvc.pattern(HttpMethod.PUT, "/api/credential/**"))
                    .permitAll()
                    .requestMatchers(mvc.pattern(HttpMethod.GET, "/api/credential/**"))
                    .permitAll()
                    .requestMatchers(mvc.pattern(HttpMethod.GET, "/api/credentials"))
                    .permitAll()

                    // status-list
                    .requestMatchers(mvc.pattern(HttpMethod.POST, "/api/status-list/**"))
                    .permitAll()

                    // public information
                    .requestMatchers(mvc.pattern(HttpMethod.GET, "/api/version"))
                    .permitAll()
                    .requestMatchers(mvc.pattern(HttpMethod.GET, "/api/status-list/**"))
                    .permitAll()
                    .requestMatchers(mvc.pattern(HttpMethod.GET, "/api/schema/**"))
                    .permitAll()
                    .requestMatchers(mvc.pattern(HttpMethod.GET, "/api/keys"))
                    .permitAll()
    ...
    // 配置accessToken攔截器。
    // .addFilterBefore(new AccessTokenFilter(accessTokenProvider),
