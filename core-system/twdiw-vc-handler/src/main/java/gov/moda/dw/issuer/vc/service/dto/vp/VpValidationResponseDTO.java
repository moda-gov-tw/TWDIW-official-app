...
public class VpValidationResponseDTO implements Serializable {
  ...
  public static class Vcs {
    ...
    public Vcs(
        String vpPath, String vcPath, Credential credential, boolean limitDisclosureSupported) {
      this.vpPath = vpPath;
      this.vcPath = vcPath;
    ...
    public static class Credential {
      ...
      public Credential(
          List<String> context,
          List<String> type,
          LinkedHashMap<String, Object> credentialStatus,
          LinkedHashMap<String, Object> credentialSchema,
          String id,
          String issuer,
          String issuanceDate,
      ...
      public boolean validate() {
        return context != null
            ...
            && !credentialSchema.isEmpty()
            && id != null
            && !id.isBlank()
            && issuer != null
            && !issuer.isBlank()
            && issuanceDate != null
            && !issuanceDate.isBlank()
            && expirationDate != null
