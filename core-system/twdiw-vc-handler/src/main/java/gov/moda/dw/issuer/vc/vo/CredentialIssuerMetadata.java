...
public class CredentialIssuerMetadata implements Serializable {
  ...
  public CredentialIssuerMetadata(String metaJson) {
    if (metaJson != null && !metaJson.isBlank()) {
      CredentialIssuerMetadata credentialIssuerMetadata =
          JsonUtils.jsToVo(metaJson, this.getClass());
      if (credentialIssuerMetadata != null) {
        ...
        this.credentialConfigurationsSupported =
            credentialIssuerMetadata.getCredentialConfigurationsSupported();
      }
    }
  }
  ...
  public boolean validate() {
    return credentialIssuer != null
        && !credentialIssuer.isBlank()
        && credentialEndpoint != null
        && !credentialEndpoint.isBlank()
  ...
  public static class CredentialConfigurationSupported {
    ...
    public CredentialConfigurationSupported(
        ...
        Map<String, Object> proofTypesSupported,
        List<Object> display) {
      this.format = format;
      this.scope = scope;
    ...
    public CredentialConfigurationSupported(String credentialConfigurationJson) {
      if (credentialConfigurationJson != null && !credentialConfigurationJson.isBlank()) {
        CredentialConfigurationSupported credentialConfigurationSupported =
            JsonUtils.jsToVo(credentialConfigurationJson, this.getClass());
        if (credentialConfigurationSupported != null) {
          ...
          this.cryptographicBindingMethodsSupported =
              credentialConfigurationSupported.getCryptographicBindingMethodsSupported();
          this.credentialSigningAlgValuesSupported =
              credentialConfigurationSupported.getCredentialSigningAlgValuesSupported();
    ...
    public CredentialConfigurationSupported setCryptographicBindingMethodsSupported(
        List<String> cryptographicBindingMethodsSupported) {
      this.cryptographicBindingMethodsSupported = cryptographicBindingMethodsSupported;
      return this;
    }
    ...
    public CredentialConfigurationSupported setCredentialSigningAlgValuesSupported(
        List<String> credentialSigningAlgValuesSupported) {
      this.credentialSigningAlgValuesSupported = credentialSigningAlgValuesSupported;
      return this;
    }
    ...
    public CredentialConfigurationSupported setCredentialDefinition(
        CredentialDefinition credentialDefinition) {
      this.credentialDefinition = credentialDefinition;
      return this;
    }
    ...
    public CredentialConfigurationSupported setProofTypesSupported(
        Map<String, Object> proofTypesSupported) {
      this.proofTypesSupported = proofTypesSupported;
      return this;
    }
    ...
    public boolean validate() {
      return format != null
          ...
          && !credentialSigningAlgValuesSupported.isEmpty()
          && credentialDefinition != null
          && credentialDefinition.validate()
  ...
  public static class CredentialDefinition {
    ...
    public CredentialDefinition(
        List<String> type, LinkedHashMap<String, Object> credentialSubject) {
      this.type = type;
    ...
    public CredentialDefinition(String credentialDefinitionJson) {
      if (credentialDefinitionJson != null && !credentialDefinitionJson.isBlank()) {
        CredentialDefinition credentialDefinition =
            JsonUtils.jsToVo(credentialDefinitionJson, this.getClass());
    ...
    public CredentialDefinition setCredentialSubject(
