 ...
 * JSON operation
 *
 * <p>supports the conversion of several data type: - JSON String (JS) - Serializable Value Object
 * (VO) - Map
 *
 * @version 20240902
 */
  ...
  public static <T> List<T> jsToList(String json, Class<T> objectClass) {
    try {
      return objectMapper.readValue(
          json, objectMapper.getTypeFactory().constructCollectionType(List.class, objectClass));
    } catch (JsonProcessingException e) {
      LOGGER.error(e.getMessage(), e);
    }
