...
public class KeyUtils {
  ...
  public static String GCMEncrypt(String plaintext, String secret_string, String iv_b64)
      throws Exception {
  ...
  public static boolean isPossiblyJwk(String issuerKey) throws Exception {
    try {
      ...
      if (!issuerKeyMap.containsKey("kty")) return false;
      String algo = (String) issuerKeyMap.get("kty");
      switch (algo) {
        case "RSA":
          return issuerKeyMap.containsKey("n") && issuerKeyMap.containsKey("e");
        case "EC":
          return issuerKeyMap.containsKey("crv")
              && issuerKeyMap.containsKey("x")
              && issuerKeyMap.containsKey("y");
        default:
          return false;
      }
    } catch (Exception e) {
