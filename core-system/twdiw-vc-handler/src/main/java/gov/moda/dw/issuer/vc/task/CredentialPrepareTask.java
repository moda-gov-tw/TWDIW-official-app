  ...
  public VerifiableCredential prepare(Map<String, Object> claims) throws VcException {
    ...
    try {
      ...
      CredentialSubject credentialSubject =
          CredentialSubject.builder().id(URI.create(holderDid)).claims(claims).build();
      ...
      CredentialStatus credentialStatusSuspension =
          StatusList2021Entry.builder()
              .id(idSuspension)
      ...
      // append schema
      JsonLDObject.fromMap(credentialSchema)
          .addToJsonLDObject(vc, Definition.VC_FIELD_NAME_CREDENTIAL_SCHEMA);
