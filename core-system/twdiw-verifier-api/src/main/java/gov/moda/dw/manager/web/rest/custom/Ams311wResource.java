...
public class Ams311wResource {
    ...
    /**
     * {@code POST /create} : Creates a new user account.
     * 建立帳號。
     */
    @PostMapping("/create")
    ...
    public ResponseEntity<ResponseDTO> createUser(@RequestBody Ams311wReqDTO ams311wReqDTO) {
        ...
        try {
            Ams311wResultDTO resultDTO = this.ams311wService.upsertUser(ams311wReqDTO, AccountActionType.CREATE, userLogin.get());
            if (resultDTO != null) {
                return ResponseEntity.ok().body(new ResponseDTO<>(resultDTO.getStatusCode()));
            }
        } catch (Exception ex) {
    ...
    /**
     * {@code POST /update} : Update user account data.
     * 更新帳號。
     */
    @PostMapping("/update")
    ...
    public ResponseEntity<ResponseDTO<Ams311wAccountResDTO>> updateUser(@RequestBody Ams311wReqDTO ams311wReqDTO) {
        ...
        try {
            Ams311wResultDTO resultDTO = this.ams311wService.upsertUser(ams311wReqDTO, AccountActionType.UPDATE, userLogin.get());
            if (resultDTO != null) {
                if (StatusCode.SUCCESS.getCode().equals(resultDTO.getStatusCode().getCode())) {
    ...
    public ResponseEntity<ResponseDTO<List<OrgResDTO>>> searchAllOrgListForAccountManagement() {
        ...
        try {
            ...
            log.error("[{}-searchAllOrgListForAccountManagement]，發生錯誤, 錯誤原因為={}", ENTITY_NAME, ExceptionUtils.getStackTrace(ex));
            return ResponseEntity.ok().body(responseDTO);
        }
    }
    ...
    public ResponseEntity<ResponseDTO<List<UserTypeIdDTO>>> searchAllUserTypeIdListForAccountManagement() {
        ...
        try {
            ...
            log.error("[{}-searchAllUserTypeIdListForAccountManagement]，發生錯誤, 錯誤原因為={}", ENTITY_NAME, ExceptionUtils.getStackTrace(ex));
            return ResponseEntity.ok().body(responseDTO);
        }
    }
    ...
    public ResponseEntity<ResponseDTO<Ams311wAccountResDTO>> changeUserActivated(@RequestBody Ams311wReqDTO ams311wReqDTO) {
        ...
        try {
            Ams311wResultDTO resultDTO = this.ams311wService.upsertUser(ams311wReqDTO, AccountActionType.CHANGE_ACTIVATED, userLogin.get());
            if (resultDTO != null) {
                if (StatusCode.SUCCESS.getCode().equals(resultDTO.getStatusCode().getCode())) {
                    return ResponseEntity.ok().body(new ResponseDTO<>(resultDTO.getAms311wAccountResDTO()));
                } else {
    ...
    public ResponseEntity<ResponseDTO<Ams311wAccountResDTO>> resetUserBwd(@RequestBody Ams311wReqDTO ams311wReqDTO) {
        ...
        try {
            Ams311wResultDTO resultDTO = this.ams311wService.upsertUser(ams311wReqDTO, AccountActionType.RESET_PWD, userLogin.get());
            if (resultDTO != null) {
                if (StatusCode.SUCCESS.getCode().equals(resultDTO.getStatusCode().getCode())) {
                    return ResponseEntity.ok().body(new ResponseDTO<>(resultDTO.getAms311wAccountResDTO()));
                } else {
    ...
    public ResponseEntity<ResponseDTO<List<RoleDTO>>> searchAllRole(@RequestBody Ams311wSearchAllRoleReqDTO reqDTO) {
        ...
        try {
            ...
            for (RoleDTO role : allRole.getContent()) {
                List<String> managerRoles = Arrays.asList(RoleType.VERIFY_ORG_MANAGER.getCode(),
                        RoleType.VERIFY_ORG_USER.getCode(), RoleType.DEFAULT_ROLE.getCode());
    ...
    public ResponseDTO updateUserRoles(@RequestBody Ams311wUpdateRolesReqDTO request) {
        ...
        try {
            ...
            Ams311wUserRolesDTO ams311wUserRolesDTO = this.ams311wService.updateUserRoles(ams311wReqDTO, roleDTOList, userLogin.get());
            if (ams311wUserRolesDTO != null) {
                responseDTO.setStatusCode(ams311wUserRolesDTO.getStatusCode());
            }
            return responseDTO;
    ...
    public ResponseDTO<Ams311wCurrentUserResDTO> queryPersonalInfo() {
        ...
        try {
            ...
            //查詢登入帳號的個人資料
            Ams311wCurrentUserResultDTO ams311wCurrentUserResultDTO = ams311wService.queryPersonalInfo(jwtUserObjectList.get(0).getUserId());
    ...
    public ResponseDTO<Ams311wCurrentUserResDTO> profileSettings(@RequestBody Ams311wCurrentUserReqDTO ams311wCurrentUserReqDTO) {
        ...
        try {
            ...
            //更新登入帳號的個人資料
            Ams311wCurrentUserResultDTO ams311wCurrentUserResultDTO = ams311wService.profileSettings(ams311wCurrentUserReqDTO);
            if (ams311wCurrentUserResultDTO != null) {
                if (ams311wCurrentUserResultDTO.getStatusCode() == StatusCode.SUCCESS) {
                    responseDTO.setData(ams311wCurrentUserResultDTO.getAms311wCurrentUserResDTO());
                }
