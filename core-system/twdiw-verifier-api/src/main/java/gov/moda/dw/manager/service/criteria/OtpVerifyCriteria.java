...
/**
 * Criteria class for the {@link gov.moda.dw.manager.domain.OtpVerify} entity. This class is used in
 * {@link gov.moda.dw.manager.web.rest.OtpVerifyResource} to receive all the possible filtering
 * options from the Http GET request parameters. For example the following could be a valid request:
 * {@code /otp-verifies?id.greaterThan=5&attr1.contains=something&attr2.specified=false} As Spring
...
public class OtpVerifyCriteria implements Serializable, Criteria {
  ...
  public boolean equals(Object o) {
    ...
    return (Objects.equals(id, that.id)
        ...
        && Objects.equals(otpToken, that.otpToken)
        && Objects.equals(otpTokenExpired, that.otpTokenExpired)
