...
public class VCItemFieldExternalResource {
  ...
  public ResponseEntity<List<VCItemFieldVdr>> getAllVCItemFieldsFromVDR(
      Pageable pageable, @RequestBody SelectCategoryVCItemReq req) {
    log.debug("REST request to get external VCItemFields");
    Page<VCItemFieldVdr> page =
        customVCItemFieldsVdrService.findFieldsByPageForOneVCItem(req, pageable);
    HttpHeaders headers =
