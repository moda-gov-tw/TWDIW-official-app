...
public class CustomExtendedUserService extends ExtendedUserService {
  ...
  public CustomExtendedUserService(
  ...
  public ExtendedUser saveExtendedUser(Ams311wReqDTO ams311wReqDTO) {
    try {
      ...
      log.error(
          "CustomExtendedUserService-saveExtendedUser-發生錯誤，原因為:{}",
  ...
  public ExtendedUser updateExtendedUser(
      Ams311wReqDTO ams311wReqDTO, AccountActionType actionType, Boolean isState) {
    try {
      Optional<ExtendedUser> dbExtendedUser =
          this.extendedUserRepository.findOneByUserId(ams311wReqDTO.getLogin());
      ...
      if (dbExtendedUser.isPresent()) {
        ...
        if (AccountActionType.CHANGE_ACTIVATED.equals(actionType)) {
          dbExtendedUser
              .get()
              .setState(isState ? StateType.ENABLED.getCode() : StateType.DISABLED.getCode());
        }
      ...
      log.error(
          "CustomExtendedUserService-updateExtendedUser-發生錯誤，原因為:{}",
          ExceptionUtils.getStackTrace(ex));
    }
    return null;
  }
