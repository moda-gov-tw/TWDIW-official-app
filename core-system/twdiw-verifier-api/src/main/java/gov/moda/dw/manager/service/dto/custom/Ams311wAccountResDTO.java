...
public class Ams311wAccountResDTO implements Serializable {
  ...
  public Ams311wAccountResDTO(User user, ExtendedUserDTO extendedUserDTO, OrgDTO orgDTO) {
    ...
    this.leftDate =
        extendedUserDTO.getLeftDate() != null
            ? DateUtils.convertDate(extendedUserDTO.getLeftDate(), "yyyy-MM-dd")
            : null;
    this.onboardDate =
        extendedUserDTO.getOnboardDate() != null
  ...
  public Ams311wAccountResDTO(User user, ExtendedUser extendedUser) {
    ...
    this.leftDate =
        extendedUser.getLeftDate() != null
            ? DateUtils.convertDate(extendedUser.getLeftDate(), "yyyy-MM-dd")
            : null;
    this.onboardDate =
        extendedUser.getOnboardDate() != null
