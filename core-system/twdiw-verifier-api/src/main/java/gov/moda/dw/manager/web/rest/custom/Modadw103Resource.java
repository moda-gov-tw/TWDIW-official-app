...
public class Modadw103Resource {
  ...
  public ResponseEntity<?> createOrgSetting(
      @Valid @RequestBody CustomOrgKeySettingDTO customOrgKeySettingDTO) {
    try {
  ...
  @GetMapping("")
  @PreAuthorize("hasAuthority('verifier_OrgKeySetting')")
  public ResponseEntity<VPOrgKeySettingResDTO> getAllOrgKeySetting(
      OrgKeySettingCriteria criteria,
    ...
    return ResponseEntity.noContent()
        .headers(
            HeaderUtil.createEntityDeletionAlert(
                applicationName, true, "org_key_setting", id.toString()))
        .build();
  }
