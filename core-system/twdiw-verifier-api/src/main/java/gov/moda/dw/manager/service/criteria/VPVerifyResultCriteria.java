...
/**
 * Criteria class for the {@link gov.moda.dw.manager.domain.VPVerifyResult} entity. This class is
 * used in {@link gov.moda.dw.manager.web.rest.VPVerifyResultResource} to receive all the possible
 * filtering options from the Http GET request parameters. For example the following could be a
 * valid request: {@code
 * /vp-verify-results?id.greaterThan=5&attr1.contains=something&attr2.specified=false} As Spring is
