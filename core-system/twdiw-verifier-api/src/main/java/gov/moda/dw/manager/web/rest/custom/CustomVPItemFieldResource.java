...
@RestController
@RequestMapping("/api/vp-item-field")
public class CustomVPItemFieldResource {

  private static final Logger log =
      LoggerFactory.getLogger(CustomVPItemFieldExternalResource.class);
  ...
  public CustomVPItemFieldResource(CustomVPItemFieldService customVPItemFieldService) {
