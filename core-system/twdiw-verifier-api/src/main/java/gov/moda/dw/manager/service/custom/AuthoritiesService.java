...
public class AuthoritiesService {
  ...
  public Set<Authority> addAuthority(String authority, Set<Authority> managedAuthorities) {
    try {
      ...
      log.error(
          "AuthoritiesService-addAuthority 新增權限發生錯誤, 原因為:{}", ExceptionUtils.getStackTrace(ex));
      return managedAuthorities;
    }
  }
  ...
  public void delAuthority(String resId) {
    try {
      ...
      log.error(
          "AuthoritiesService-delAuthority 刪除權限發生錯誤, 原因為:{}", ExceptionUtils.getStackTrace(ex));
    }
  }
}
