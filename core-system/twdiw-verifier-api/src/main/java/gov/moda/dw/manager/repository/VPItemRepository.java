...
@Repository
public interface VPItemRepository
    extends JpaRepository<VPItem, Long>, JpaSpecificationExecutor<VPItem> {
  ...
  Page<CustomVPItemDTO> getVPPage(
      @Param("crUser") Long crUser, @Param("businessId") String businessId, Pageable pageable);
}
