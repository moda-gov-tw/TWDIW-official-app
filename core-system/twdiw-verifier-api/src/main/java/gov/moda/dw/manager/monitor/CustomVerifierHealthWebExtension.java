...
public class CustomVerifierHealthWebExtension extends HealthEndpointWebExtension {
    ...
    public WebEndpointResponse<HealthComponent> health(
        ...
        if (buildProperties != null) {
            log.info("CustomVerifierHealthWebExtension: Health check triggered, twdiw-release={}, image-version={}",
                buildProperties.get("twdiw-release.version"),
                buildProperties.getVersion()
            );
        } else {
            log.info("CustomVerifierHealthWebExtension: Health check triggered, but buildProperties is null.");
        }
        ...
        if (body instanceof Health health) {
            ...
            if (buildProperties != null) {
                twdiwReleaseMap.put("moda-digitalwallet-docker-verifier-manager-service", (String) buildProperties.get("twdiw-release.version"));
                imageVersionMap.put("moda-digitalwallet-docker-verifier-manager-service", buildProperties.getVersion());
            }
            ...
            if (vpServiceInfo != null) {
                if (vpServiceInfo.containsKey("twdiw-release")) {
                    twdiwReleaseMap.put("moda-digitalwallet-docker-verifier-vp-service", vpServiceInfo.get("twdiw-release"));
                }
                if (vpServiceInfo.containsKey("image-version")) {
                    imageVersionMap.put("moda-digitalwallet-docker-verifier-vp-service", vpServiceInfo.get("image-version"));
                }
            }
            ...
            if (oid4vpServiceInfo != null) {
                if (oid4vpServiceInfo.containsKey("twdiw-release")) {
                    twdiwReleaseMap.put("moda-digitalwallet-docker-verifier-oid4vp-service", oid4vpServiceInfo.get("twdiw-release"));
                }
                if (oid4vpServiceInfo.containsKey("image-version")) {
                    imageVersionMap.put("moda-digitalwallet-docker-verifier-oid4vp-service", oid4vpServiceInfo.get("image-version"));
                }
            }
