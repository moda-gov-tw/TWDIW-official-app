...
public class RemoteApiService {
  ...
  public VerifierOid4vp101iRespDTO verifierOid4vp101i(
      String ref, String transactionId, String callback) {
    ...
    try {
      ...
      ResponseEntity<VerifierOid4vp101iRespDTO> stringResponseEntity =
          client
              .get()
              .uri(builder.build().toString())
              .retrieve()
              .toEntity(VerifierOid4vp101iRespDTO.class);
  ...
  public CategoryVdrResp getCategory() {
    ...
    try {
      ResponseEntity<CategoryVdrResp> stringResponseEntity =
          client
              .get()
              .uri(UriComponentsBuilder.fromUriString(url).build().toString())
              .retrieve()
              .toEntity(CategoryVdrResp.class);
      return stringResponseEntity.getBody();
      ...
      if (e.getStatusCode() == HttpStatus.NOT_FOUND) {
        throw new BadRequestAlertException(
            ...
            errorBody,
            "RemoteApiService ApiResponse not found error in getCategory()");
      } else {
        throw new RuntimeException(errorBody);
      }
    }
