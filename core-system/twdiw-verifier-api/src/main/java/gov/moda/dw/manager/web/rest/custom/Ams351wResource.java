...
public class Ams351wResource {
  ...
  public Ams351wResource(
      DynamicDtoUtils dynamicDtoUtils,
      Ams351wService ams351wService,
  ...
  public ResponseEntity<ResponseDTO<List<Map<String, Object>>>> findAccessTokenListByConditions(
    ...
    try {
      ...
      Ams351wSearchAllTokenResultDTO resultDTO =
          this.ams351wService.getAllAccessToken(ams351WReqDTO, pageable);
      ...
      log.error(
          "Ams351wResource-findAccessTokenListByConditions-發生錯誤，原因為:{}",
          ExceptionUtils.getStackTrace(ex));
    }
    return ResponseEntity.ok().body(new ResponseDTO<>(StatusCode.TOKEN_SEARCH_DB_EXCEPTION));
  }

  /** {@code POST /modadw351w} : Create a new accessToken. 建立AccessToken。 */
  ...
  public ResponseEntity<ResponseDTO> createAccessToken(@RequestBody Ams351wReqDTO ams351wReqDTO) {
    ...
    try {
      Ams351wResultDTO resultDTO =
          this.ams351wService.upsertAccessToken(ams351wReqDTO, AuthorityAction.ACCESS_TOKEN_CREATE);
      if (resultDTO != null) {
        return ResponseEntity.ok().body(new ResponseDTO<>(resultDTO.getStatusCode()));
      }
    } catch (Exception ex) {
  ...
  public ResponseEntity<ResponseDTO<Ams351wAccessTokenResDTO>> updateAccessToken(
      @RequestBody Ams351wReqDTO ams351wReqDTO) {
    ...
    try {
      Ams351wResultDTO resultDTO =
          this.ams351wService.upsertAccessToken(
              ams351wReqDTO, AuthorityAction.ACCESS_TOKEN_UPDATE_RES);
      if (resultDTO != null) {
        if (StatusCode.SUCCESS.getCode().equals(resultDTO.getStatusCode().getCode())) {
          return ResponseEntity.ok()
              .body(new ResponseDTO<>(resultDTO.getAms351wAccessTokenResDTO()));
        }
        return ResponseEntity.ok().body(new ResponseDTO<>(resultDTO.getStatusCode()));
      }
    } catch (Exception ex) {
  ...
  public ResponseEntity<ResponseDTO<Ams351wAccessTokenResDTO>> changeAccessTokenState(
      @RequestBody Ams351wReqDTO ams351wReqDTO) {
    ...
    try {
      Ams351wResultDTO resultDTO =
          this.ams351wService.upsertAccessToken(
              ams351wReqDTO, AuthorityAction.ACCESS_TOKEN_CHANGE_ACTIVATED);
      if (resultDTO != null) {
        if (StatusCode.SUCCESS.getCode().equals(resultDTO.getStatusCode().getCode())) {
          return ResponseEntity.ok()
              .body(new ResponseDTO<>(resultDTO.getAms351wAccessTokenResDTO()));
      ...
      log.error(
          "Ams351wResource-updateAccessTokenState-發生錯誤，原因為:{}", ExceptionUtils.getStackTrace(ex));
    }
    return ResponseEntity.ok().body(new ResponseDTO<>(StatusCode.TOKEN_CREATE_EXCEPTION));
  }
  ...
  public ResponseEntity<ResponseDTO<MenuTreeDTO>> searchResTree(
      @RequestBody Ams351wReqDTO request) {
    ...
    try {
      ...
      MenuTreeDTO treeDTO =
          this.menuTreeService.readTree(request.getId(), RelType.ACCESSTOKENTORES, ResType.API);
  ...
  public ResponseEntity<ResponseDTO> upsertRel(@RequestBody Ams351wRelReqDTO ams351wRelReqDTO) {
    ...
    try {
      StatusCode result =
          ams351wService.updateRel(ams351wRelReqDTO, AuthorityAction.ACCESS_TOKEN_UPDATE_RES);
      if (result != null) {
  ...
  public ResponseEntity<ResponseDTO<List<ResDTO>>> getAccessTokenResList(
      @RequestBody Ams351wResReqDTO request) {
    ...
    try {
      ...
      if (resultDTO.getStatusCode().equals(StatusCode.SUCCESS)) {
        return ResponseEntity.ok()
            .body(
                new ResponseDTO<>(
                    resultDTO.getResDTOList() == null
                        ? new ArrayList<>()
                        : resultDTO.getResDTOList()));
      } else {
        return ResponseEntity.ok().body(new ResponseDTO<>(resultDTO.getStatusCode()));
      }
    } catch (Exception ex) {
      log.error(
          "Ams351wResource-getAccessTokenAllRes-發生錯誤，原因為:{}", ExceptionUtils.getStackTrace(ex));
      return ResponseEntity.ok().body(new ResponseDTO<>(StatusCode.TOKEN_SEARCH_DB_EXCEPTION));
    }
  }
