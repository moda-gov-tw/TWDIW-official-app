        ...
        .authorizeHttpRequests(
            authz ->
                ...
                authz
                    ...
                    .permitAll()
                    .requestMatchers(mvc.pattern("/api/terms/**"))
                    .permitAll()
                    ...
                    .permitAll()
                    .requestMatchers(mvc.pattern("/api/verifier/data/**"))
                    .permitAll()
                    .requestMatchers(mvc.pattern("/api/verifier/deepLink/**"))
                    .permitAll()
                    .requestMatchers(mvc.pattern("/api/verifier/result"))
                    .permitAll()
