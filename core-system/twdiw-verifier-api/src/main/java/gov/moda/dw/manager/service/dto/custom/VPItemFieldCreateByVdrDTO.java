...
public class VPItemFieldCreateByVdrDTO implements Serializable {
  /** VC BusinessId */
  @NotBlank private String vcBusinessId;
  ...
  /** VP id 外鍵 */
  @JsonIgnore private Long vpItemId;

  /** VC類別描述 */
  @JsonIgnore private String vcCategoryDescription = "VDR";

  /** 欄位類別 */
  @JsonIgnore private String vcItemFieldType = "VDR";
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(vcBusinessId, that.vcBusinessId)
