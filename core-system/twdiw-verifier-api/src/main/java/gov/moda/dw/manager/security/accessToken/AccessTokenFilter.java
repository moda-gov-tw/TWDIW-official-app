...
public class AccessTokenFilter extends GenericFilterBean {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain)
        ...
        if (!isTokenExisted) {
            ...
            log.info("AccessTokenFilter-doFilter，取得此次請求中的AccessToken，請求IP位置:{}，accessToken:{}", sourceIp, accessToken);
            ...
            if (StatusCode.SUCCESS.getCode().equals(accessTokenValidated.getCode())) {
                ...
                servletRequest.setAttribute("FROM", ((AccessTokenUserObject) authentication.getPrincipal()).getOwnerName());
                servletRequest.setAttribute("EXT", true);

                log.info("AccessTokenFilter-doFilter，AccessToken驗證成功，authentication:{}，權限List:{}", authentication,
