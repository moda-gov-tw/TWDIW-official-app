...
/**
 * Criteria class for the {@link VcManagerVCItem} entity. This class is used in {@link
 * gov.moda.dw.manager.web.rest.outside.VCItemResource} to receive all the possible filtering
 * options from the Http GET request parameters. For example the following could be a valid request:
 * {@code /vc-items?id.greaterThan=5&attr1.contains=something&attr2.specified=false} As Spring is
