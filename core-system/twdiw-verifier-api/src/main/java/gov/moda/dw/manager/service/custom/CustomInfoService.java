...
public class CustomInfoService {
  ...
  public CustomVersionInfoResDTO getVersionInfo() {
    ...
    // 取得 VERIFIERMGR 環境資訊
    CustomVersionInfoDetailResDTO verifiermgrVersionInfoDetailResDTO =
        getVersionInfoDetail(SystemCode.VERIFIERMGR);
    customVersionInfoResDTO.setVerifiermgr(verifiermgrVersionInfoDetailResDTO);

    // 取得 OID4P 環境資訊
    CustomVersionInfoDetailResDTO oid4pVersionInfoDetailResDTO =
        getVersionInfoDetail(SystemCode.OID4P);
