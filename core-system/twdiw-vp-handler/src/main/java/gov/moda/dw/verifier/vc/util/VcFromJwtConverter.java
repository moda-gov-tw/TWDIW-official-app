...
public class VcFromJwtConverter {
  ...
  public static VerifiableCredential fromJwtVerifiableCredential(
    ...
    VerifiableCredential payloadVerifiableCredential =
        VerifiableCredential.fromJson(
            ((VerifiableCredential) jwtVerifiableCredential.getPayloadObject()).toString());
    ...
    VcBuilder<? extends VcBuilder<?>> verifiableCredentialBuilder =
        getBuilder().base(payloadVerifiableCredential).defaultContexts(false).defaultTypes(false);
