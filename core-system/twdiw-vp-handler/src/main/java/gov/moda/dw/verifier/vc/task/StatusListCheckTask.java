...
public class StatusListCheckTask {
  ...
  public StatusListCheckResult validate(int statusListIndex, String statusList) throws VpException {
    ...
    try {
      ...
      StatusListValidateTask.ContentResult contentResult =
          statusListValidateTask.validateJwtContent(jwt);
      ...
      throw new VpException(
          VpException.ERR_CRED_VALIDATE_VC_STATUS_ERROR, "fail to check from status list");
    }
  ...
  public record StatusListInfo(
      String statusListCredentialURL, Integer statusListIndex, String statusPurpose) {
    ...
    public String toString() {
      ...
      sb.append("\"statusListCredentialURL\":\"").append(statusListCredentialURL).append('\"');
      sb.append(",\"statusListIndex\":").append(statusListIndex);
      sb.append(",\"statusPurpose\":\"").append(statusPurpose).append('\"');
      sb.append("}");
      return sb.toString();
    }
  }
