...
public class PresentationValidationResponseDTO implements Serializable {
  ...
  public PresentationValidationResponseDTO(
      String clientId, String nonce, List<VcData> vcs, String holderDid) {
  ...
  public PresentationValidationResponseDTO(String respJson) {
    ...
    if (respJson != null && !respJson.isBlank()) {
      PresentationValidationResponseDTO presentationValidationResponseDTO =
          JsonUtils.jsToVo(respJson, getClass());
  ...
  public static class VcData {
    ...
    @Deprecated private Map<String, Object> claims;
    @JsonIgnore private Map<String, Object> holderPublicKey;
    @JsonIgnore private String sub;
