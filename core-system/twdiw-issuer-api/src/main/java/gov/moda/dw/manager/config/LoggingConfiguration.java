...
import gov.moda.dw.monitor.health.CustomHealthWebExtension;
...
import gov.moda.dw.monitor.info.LoggingAppInfoContributorConfiguration;
 ...
 */
@Configuration
@Import({LoggingAppInfoContributorConfiguration.class, CustomHealthWebExtension.class})
