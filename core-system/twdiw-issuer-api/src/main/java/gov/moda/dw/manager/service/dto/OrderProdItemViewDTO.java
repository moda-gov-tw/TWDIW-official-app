...
/**
 * A DTO for the {@link gov.moda.dw.manager.domain.OrderProdItemView} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class OrderProdItemViewDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OrderProdItemViewDTO)) {
            return false;
        }

        OrderProdItemViewDTO orderProdItemViewDTO = (OrderProdItemViewDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, orderProdItemViewDTO.id);
    }
