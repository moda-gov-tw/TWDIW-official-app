...
public interface CustomVCItemDataRepository extends VCItemDataRepository {
  ...
  int updateValidAndMessageById(
      @Param("valid") Integer valid, @Param("id") Long id, @Param("msg") String msg);
  ...
  List<VCItemData> findByClearScheduleIdAndClearScheduleDatetime(
  ...
  @Query(
      value = CLEAR_VC_ITEM_DATA_LIST_SQL,
      countQuery = CLEAR_VC_ITEM_DATA_LIST_SQL,
      nativeQuery = true)
  Page<ClearVcItemDataDTO> findClearVcItemDataList(
      @Param("validType") int validType,
      @Param("clearScheduleId") long clearScheduleId,
      @Param("clearScheduleDatetime") Instant clearScheduleDatetime,
      Pageable pageable);
  ...
  Page<GetVcItemDataDTO> findVcItemData(
      @Param("dataTag") String dataTag,
      @Param("vcUid") String vcUid,
      @Param("credentialStatus") String credentialStatus,
      Pageable pageable);
