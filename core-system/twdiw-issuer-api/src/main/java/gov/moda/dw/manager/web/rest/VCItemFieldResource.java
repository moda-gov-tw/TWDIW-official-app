...
public class VCItemFieldResource {
   ...
   *     vCItemFieldDTO, or with status {@code 400 (Bad Request)} if the vCItemField has already an
   *     ID.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  //    @PostMapping("")
  //    public ResponseEntity<VCItemFieldDTO> createVCItemField(@Valid @RequestBody VCItemFieldDTO
  // vCItemFieldDTO) throws URISyntaxException {
  //        log.debug("REST request to save VCItemField : {}", vCItemFieldDTO);
  //        if (vCItemFieldDTO.getId() != null) {
  //            throw new BadRequestAlertException("A new vCItemField cannot already have an ID",
   ...
   *     vCItemFieldDTO, or with status {@code 400 (Bad Request)} if the vCItemFieldDTO is not
   *     valid, or with status {@code 500 (Internal Server Error)} if the vCItemFieldDTO couldn't be
   *     updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  //    @PutMapping("/{id}")
  ...
  /**
   * {@code PATCH /vc-item-fields/:id} : Partial updates given fields of an existing vCItemField,
   ...
   * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated
   *     vCItemFieldDTO, or with status {@code 400 (Bad Request)} if the vCItemFieldDTO is not
   *     valid, or with status {@code 404 (Not Found)} if the vCItemFieldDTO is not found, or with
   *     status {@code 500 (Internal Server Error)} if the vCItemFieldDTO couldn't be updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  ...
  //    ) throws URISyntaxException {
  //        log.debug("REST request to partial update VCItemField partially : {}, {}", id,
  // vCItemFieldDTO);
  //        if (vCItemFieldDTO.getId() == null) {
  //            throw new BadRequestAlertException("Invalid id", ENTITY_NAME, "idnull");
  //        }
   ...
   * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of vCItemFields in
   *     body.
   */
  @GetMapping("")
   ...
   *     vCItemFieldDTO, or with status {@code 404 (Not Found)}.
   */
  //    @GetMapping("/{id}")
