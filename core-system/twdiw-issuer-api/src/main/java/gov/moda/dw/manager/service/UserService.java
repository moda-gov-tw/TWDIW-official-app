...
import gov.moda.dw.manager.service.dto.UserDTO;
...
public class UserService {
    ...
    public Optional<User> activateRegistration(String key) {
        ...
        return userRepository
            ...
            .map(user -> {
                ...
                log.debug("Activated user: {}", user.getId());
                return user;
            });
    }
    ...
    public User createUser(AdminUserDTO userDTO) {
        ...
        log.debug("Created Information for User: {}", user.getId());
        return user;
    }
    ...
    public Optional<AdminUserDTO> updateUser(AdminUserDTO userDTO) {
        return Optional.of(userRepository.findById(userDTO.getId()))
            ...
            .map(user -> {
                ...
                userRepository.save(user);
                log.debug("Changed Information for User: {}", user.getId());
                return user;
            })
    ...
    public void deleteUser(String login) {
        userRepository
            ...
            .ifPresent(user -> {
                ...
                log.debug("Deleted User: {}", user.getEmail());
            });
    }
