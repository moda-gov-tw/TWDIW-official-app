...
/**
 * Criteria class for the {@link gov.moda.dw.manager.domain.VCDataStatusLog} entity. This class is
 * used in {@link gov.moda.dw.manager.web.rest.VCDataStatusLogResource} to receive all the possible
 * filtering options from the Http GET request parameters. For example the following could be a
 * valid request: {@code
 * /vc-data-status-logs?id.greaterThan=5&attr1.contains=something&attr2.specified=false} As Spring
...
public class VCDataStatusLogCriteria implements Serializable, Criteria {
  ...
  public int hashCode() {
    return Objects.hash(
        id, vcCid, vcItemId, transactionId, valid, crUser, crDatetime, lastUpdateTime, distinct);
  }

  // prettier-ignore
  @Override
  public String toString() {
    return "VCDataStatusLogCriteria{"
