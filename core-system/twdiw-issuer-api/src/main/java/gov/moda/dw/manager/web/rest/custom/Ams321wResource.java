...
public class Ams321wResource {
  ...
  public ResponseEntity<ResponseDTO<List<Ams321wRoleResDTO>>> searchAllRole(
      Pageable pageable, @RequestBody Ams321wReqDTO request) {
  ...
  public ResponseDTO<List<Ams321wRoleConferResDTO>> getRoleAllRes(
      @RequestBody Ams321wReqDTO request) {
    ...
    try {
      ...
      // 查詢角色已授權功能列表
      Ams321wRoleConferRultDTO ams321wRoleConferResDTO =
          ams321wService.searchRoleConferRes(request);
  ...
  public ResponseDTO<List<Ams321wRoleConferResDTO>> saveConferRes(
      @RequestBody Ams321wRoleConferReqDTO ams321wRelDTO) {
    log.info("Ams321wResource-saveConferRes 準備儲存角色授權的功能");
    ResponseDTO<List<Ams321wRoleConferResDTO>> responseDTO = new ResponseDTO<>();
    try {
      Ams321wRoleConferRultDTO ams321wRoleConferResDTO =
          ams321wService.saveConferRes(ams321wRelDTO);
      if (ams321wRoleConferResDTO != null) {
        if (ams321wRoleConferResDTO.getStatusCode() == StatusCode.SUCCESS) {
          responseDTO.setData(ams321wRoleConferResDTO.getAms321wRoleResResponseDTOList());
        }
