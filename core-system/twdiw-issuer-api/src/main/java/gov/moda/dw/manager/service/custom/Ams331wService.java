...
public class Ams331wService {
  ...
  public Ams331wUpdateStateResDTO updateState(Ams331wReqDTO ams331wReqDTO) {
    ...
    try {
      ...
      if (opRes.isPresent()) {
        ...
        log.error(
            "Ams331wService-updateState 查詢不到功能資料, 無法執行更改啟/停狀態 resId={}", ams331wReqDTO.getResId());
  ...
  public void saveResLog(ResDTO resDTO, LogType logType) {
    log.info(
        "Ams331wService-saveResLog 開始紀錄功能{}異動 ResDTO={} LogType={}",
        logType.getName(),
        resDTO,
        logType);
    ...
    log.info(
        "Ams331wService-saveResLog 紀錄功能{}異動完成 ResDTO={} LogType={}",
        logType.getName(),
        resDTO,
        logType);
  }
