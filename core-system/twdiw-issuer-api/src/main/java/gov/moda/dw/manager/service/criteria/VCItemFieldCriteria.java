...
/**
 * Criteria class for the {@link gov.moda.dw.manager.domain.VCItemField} entity. This class is used
 * in {@link gov.moda.dw.manager.web.rest.VCItemFieldResource} to receive all the possible filtering
 * options from the Http GET request parameters. For example the following could be a valid request:
 * {@code /vc-item-fields?id.greaterThan=5&attr1.contains=something&attr2.specified=false} As Spring
...
public class VCItemFieldCriteria implements Serializable, Criteria {
  ...
  private IntegerFilter cardCoverData;
  ...
  public VCItemFieldCriteria(VCItemFieldCriteria other) {
    ...
    this.regularExpressionId =
        other.regularExpressionId == null ? null : other.regularExpressionId.copy();
  }
  ...
  public LongFilter regularExpressionId() {
    if (regularExpressionId == null) {
      regularExpressionId = new LongFilter();
    }
    return regularExpressionId;
  }

  public void setRegularExpressionId(LongFilter regularExpressionId) {
    this.regularExpressionId = regularExpressionId;
  }

  public void setCardCoverData(IntegerFilter cardCoverData) {
  ...
  public boolean equals(Object o) {
    ...
    return (Objects.equals(id, that.id)
        ...
        && Objects.equals(cardCoverData, that.cardCoverData)
        && Objects.equals(regularExpressionId, that.regularExpressionId)
  ...
  public int hashCode() {
    return Objects.hash(
        id, vcItemId, type, cname, ename, distinct, regularExpressionId, isRequired);
  }
  ...
  public String toString() {
    return "VCItemFieldCriteria{"
        + (id != null ? "id=" + id + ", " : "")
        + (vcItemId != null ? "vcItemId=" + vcItemId + ", " : "")
        + (type != null ? "type=" + type + ", " : "")
        + (cname != null ? "cname=" + cname + ", " : "")
        + (ename != null ? "ename=" + ename + ", " : "")
        + (cardCoverData != null ? "cardCoverData=" + cardCoverData + ", " : "")
