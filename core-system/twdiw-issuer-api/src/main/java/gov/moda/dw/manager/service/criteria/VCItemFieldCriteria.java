 ...
 * in {@link gov.moda.dw.manager.web.rest.VCItemFieldResource} to receive all the possible filtering options from
...
public class VCItemFieldCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, vcItemId, type, cname, ename, distinct, regularExpressionId, isRequired);
    }
