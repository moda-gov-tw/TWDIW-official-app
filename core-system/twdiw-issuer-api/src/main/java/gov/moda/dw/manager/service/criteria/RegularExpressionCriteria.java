...
/**
 * Criteria class for the {@link gov.moda.dw.manager.domain.RegularExpression} entity. This class is
 * used in {@link gov.moda.dw.manager.web.rest.RegularExpressionResource} to receive all the
 * possible filtering options from the Http GET request parameters. For example the following could
 * be a valid request: {@code
 * /regular-expressions?id.greaterThan=5&attr1.contains=something&attr2.specified=false} As Spring
...
public class RegularExpressionCriteria implements Serializable, Criteria {
  ...
  public RegularExpressionCriteria(RegularExpressionCriteria other) {
    ...
    this.regularExpression =
        other.regularExpression == null ? null : other.regularExpression.copy();
