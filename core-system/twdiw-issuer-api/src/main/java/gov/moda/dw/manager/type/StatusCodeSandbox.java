...
public enum StatusCodeSandbox {
  ...
  Data_Field_Count_Mismatch_With_VC_Template(
      "S4003", "資料欄位與VC模版欄位定義的數量不一致", "Data_Field_Count_Mismatch_With_VC_Template"),
  Data_Field_Order_Mismatch_With_VC_Template(
      "S4004", "資料欄位與VC模版欄位定義的順序不一致", "Data_Field_Order_Mismatch_With_VC_Template"),
  VC_Template_Field_Not_Found_In_Data(
      "S4005", "VC模版欄位定義的欄位在資料中不存在", "VC_Template_Field_Not_Found_In_Data"),
  Duplicate_VC_Template_TransactionId(
      "S4006", "VC模版的TransactionId重覆", "Duplicate_VC_Template_TransactionId"),
  ...
  Type_Or_IssuerServiceUrl_Missing(
      "S4012", "Type 與 IssuerServiceUrl 必須同時存在或同時為空", "Type_Or_IssuerServiceUrl_Missing"),
  The_VC_Template_Is_Not_Used_And_Can_Be_Deleted_Directly(
      "S4013", "VC模版未使用，可直接刪除", "The_VC_Template_Is_Not_Used_And_Can_Be_Deleted_Directly"),
  // vc資料
  ...
  VC_Data_ExpiredDate_Not_Allowed(
      "S5006", "到期日不可以早於今日或建立 VC 模板日期", "VC_Data_ExpiredDate_Not_Allowed"),
