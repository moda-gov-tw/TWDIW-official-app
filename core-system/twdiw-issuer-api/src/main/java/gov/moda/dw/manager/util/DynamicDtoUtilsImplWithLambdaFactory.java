 ...
 *
 * <p>This class provides methods to convert a list of DTOs or a single DTO to a list of maps or a
 * map respectively. 提供將DTO轉換為Map的工具類。 此類提供將DTO列表或單一DTO轉換為Map列表或Map的方法。
 */
@Slf4j
@Component
@Primary
    ...
    for (Field field : clazz.getDeclaredFields()) {
      try {
        ...
        MethodHandle getterHandle =
            lookup.findVirtual(
                clazz, getterName, MethodType.methodType(getterMethod.getReturnType()));
