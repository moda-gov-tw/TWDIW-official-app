...
/**
 * Criteria class for the {@link gov.moda.dw.manager.domain.Category} entity. This class is used
 * in {@link gov.moda.dw.manager.web.rest.CategoryResource} to receive all the possible filtering options from
