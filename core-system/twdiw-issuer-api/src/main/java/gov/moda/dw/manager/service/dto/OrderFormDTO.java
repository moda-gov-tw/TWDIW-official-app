...
public class OrderFormDTO implements Serializable {
  ...
  public String toString() {
    return "OrderFormDTO{"
        ...
        + getStatus()
        + "'"
        + ", customerActivityUUid='"
        + getCustomerActivityUUid()
        + "'"
        + ", customerActivityTime='"
        + getCustomerActivityTime()
        + "'"
        + ", customerActivityName='"
        + getCustomerActivityName()
        + "'"
        + ", temporaryDepositsRemark='"
        + getTemporaryDepositsRemark()
        + "'"
        + ", createTime='"
        + getCreateTime()
        + "'"
