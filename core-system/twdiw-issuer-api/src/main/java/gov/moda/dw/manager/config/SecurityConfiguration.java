    ...
    http.cors(withDefaults())
        ...
        .authorizeHttpRequests(
            authz ->
                // prettier-ignore
                authz
                    .requestMatchers(mvc.pattern("/customError"))
                    .permitAll()
                    ...
                    .permitAll()
                    .requestMatchers(mvc.pattern("/api/modadw301w/reset-bwd/init"))
                    .permitAll()
                    .requestMatchers(mvc.pattern("/api/modadw311w/validate/key"))
                    .permitAll()
                    .requestMatchers(mvc.pattern("/api/modadw311w/activate"))
                    .permitAll()
                    .requestMatchers(mvc.pattern("/api/modadw303w/generateNonce"))
                    .permitAll()
                    .requestMatchers(mvc.pattern("/api/modadw303w/generateOtp"))
                    .permitAll()
                    .requestMatchers(mvc.pattern("/api/modadw303w/verifyOtp"))
                    .permitAll()
                    .requestMatchers(mvc.pattern("/api/images/**"))
                    .permitAll()
                    .requestMatchers(mvc.pattern("/api/redirect/**"))
                    .permitAll()
                    .requestMatchers(mvc.pattern("/api/issuer/data/**"))
                    .permitAll()
                    .requestMatchers(mvc.pattern("/api/ext/**"))
                    .permitAll()
                    .requestMatchers(mvc.pattern("/api/logo/**"))
                    .permitAll()
                    .requestMatchers(mvc.pattern("/api/getVcData/**"))
                    .permitAll()
                    .requestMatchers(mvc.pattern("/api/info/**"))
                    .permitAll()

                    // FIXME: 移除以下測試用 API 權限
                    .requestMatchers(mvc.pattern("/api/ping"))
                    .permitAll()
                    .requestMatchers(mvc.pattern("/api/testSendTBB"))
                    .permitAll()
                    .requestMatchers(mvc.pattern("/test/**"))
                    .permitAll()
                    .requestMatchers(mvc.pattern("/api/modadw201w/**"))
                    .permitAll()
                    .requestMatchers(mvc.pattern("/api/modadw302w/reset-bwd/**"))
                    .permitAll()
                    .requestMatchers(mvc.pattern("/api/modadw304w/**"))
                    .permitAll()
                    .requestMatchers(mvc.pattern("/api/modadw351w/**"))
                    .permitAll()
                    .requestMatchers(mvc.pattern("/api/modadw701w/**"))
                    .permitAll()
                    // .requestMatchers(mvc.pattern("/api/vc-item-data/test/fake901iVCDataProvider")).permitAll()
