...
public class ScheduleResource {
   ...
   *     scheduleDTO, or with status {@code 400 (Bad Request)} if the scheduleDTO is not valid, or
   *     with status {@code 500 (Internal Server Error)} if the scheduleDTO couldn't be updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PreAuthorize("hasAuthority('vcSchema_clearData')")
  @PutMapping("/{id}")
  ...
  /**
   * {@code PATCH /schedules/:id} : Partial updates given fields of an existing schedule, field will
   ...
   * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated
   *     scheduleDTO, or with status {@code 400 (Bad Request)} if the scheduleDTO is not valid, or
   *     with status {@code 404 (Not Found)} if the scheduleDTO is not found, or with status {@code
   *     500 (Internal Server Error)} if the scheduleDTO couldn't be updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PreAuthorize("hasAuthority('vcSchema_clearData')")
  @PatchMapping(
