...
public class Ams311wService {
  ...
  /** 建立、更新帳號。 */
  @Transactional
  public Ams311wResultDTO upsertUser(
      Ams311wReqDTO ams311wReqDTO, AccountActionType actionType, String userLogin) {
    try {
      // 存入時統一轉為小寫
      ...
      if (StatusCode.SUCCESS.getCode().equals(result.getCode())) {
        ...
        if (AccountActionType.CREATE.equals(actionType)) {
          ...
          List<RoleDTO> roleDTOList =
              relService.accountAction(saveResult, null, AuthorityAction.ACCOUNT_SET_DEFAULT_ROLE);
          if (roleDTOList == null) {
        ...
        if (saveResult != null) {
          ...
          if (actionType.equals(AccountActionType.CREATE)) {
            ...
            extendedSaveResult =
                this.customExtendedUserService.updateExtendedUser(
                    ams311wReqDTO, actionType, saveResult.isActivated());
          }
          ...
          if (extendedSaveResult != null) {
            ...
            if (actionType.equals(AccountActionType.CREATE)) {
              ...
              AccessToken accessTokenResult =
                  customAccessTokenService.saveAccessToken4CreateUser(ams351wReqDTO);
              ...
              Optional<AccessToken> optionalAccessToken =
                  customAccessTokenRepository.findFirstByOwnerOrderByCreateTimeDesc(
                      ams311wReqDTO.getLogin());
          ...
          if (extendedSaveResult != null) {
            if (actionType.equals(AccountActionType.CREATE)
                || actionType.equals(AccountActionType.RESET_PWD)) {
              StatusCode mailResult =
                  this.doSendMail(
                      saveResult, extendedSaveResult, actionType, accessToken, null, null);
  ...
  public Page<Ams311wAccountResDTO> getAllUser(Pageable pageable, Ams311wReqDTO ams311wReqDTO) {
    log.info("Ams311wService-getAllUser 開始查詢帳號清單 ams311wReqDTO={}", ams311wReqDTO);
    try {
      // 取得JwtUserDTO
      JwtUserDTO jwtUserDTO = null;
      jwtUserDTO = this.extractJwtUser();
      ...
      ExtendedUserCriteria extendedUserCriteria =
          this.setCriteriaFromSearch(isAdminRole, ams311wReqDTO, jwtUserDTO);
      List<ExtendedUserDTO> extendedUserDTOList =
          this.customExtendedUserQueryService.findByCriteria(
              extendedUserCriteria, pageable.getSort());
      ...
      return this.getAllUserWithUserAndExtendedUser(
          extendedUserDTOList, logins, users, pageable, ams311wReqDTO);
    } catch (Exception ex) {
  ...
  public List<RoleDTO> getUserRoles(String userId) {
    ...
    List<RoleDTO> roleDTOList =
        relService.accountAction(user, null, AuthorityAction.ACCOUNT_SEARCH_ROLE);
    return roleDTOList;
  }
  ...
  public boolean hasAdminRole(JwtUserDTO jwtUserDTO) {
    ...
    for (RoleDTO dto : roleDTOS) {
      if (RoleType.ISSUER_ADMIN.getCode().equals(dto.getRoleId())
          || RoleType.VERIFY_ADMIN.getCode().equals(dto.getRoleId())) {
  ...
  public Ams311wDetailResultDTO queryByOne(Long extendedId) {
    ...
    try {
      Optional<ExtendedUserDTO> dbResultByExtendedUser =
          this.customExtendedUserService.findOne(extendedId);
      ...
      Optional<User> dbResultByUser =
          this.userRepository.findOneByLogin(dbResultByExtendedUser.get().getUserId());
      ...
      Ams311wAccountResDTO ams311wAccountResDTO =
          new Ams311wAccountResDTO(dbResultByUser.get(), dbResultByExtendedUser.get(), orgDTO);
  ...
  private Page<Ams311wAccountResDTO> getAllUserWithUserAndExtendedUser(
    ...
    for (String login : logins) {
      try {
        ...
        Ams311wAccountResDTO dto =
            new Ams311wAccountResDTO(foundUser, foundExtendedUserDTO, orgDTO);
        ...
        log.error(
            "Ams311wService-getAllUserAccountWithUserAndExtendedUser-發生錯誤，原因為:{}",
            ExceptionUtils.getStackTrace(ex));
      }
    }
    // 計算分頁起始位置和結束位置。
  ...
  /** 帳號授權角色。 */
  public Ams311wUserRolesDTO updateUserRoles(
      Ams311wReqDTO ams311wReqDTO, List<RoleDTO> roleDTOList, String userLogin) {
    try {
      ...
      // 檢查傳入的值。
      if (ams311wReqDTO == null
          || ams311wReqDTO.getLogin() == null
          || ams311wReqDTO.getId() == null) {
      ...
      ExtendedUser extendedSaveResult =
          this.customExtendedUserService.updateExtendedUser(
              ams311wReqDTO, AccountActionType.CHANGE_ROLE, ams311wReqDTO.getActivated());
  ...
  private void updateUserAuthority(
    ...
    if (userOptional.isPresent()) {
      ...
      List<RoleDTO> roleDTOS =
          relService.accountAction(user, roleDTOList, AuthorityAction.ACCOUNT_CONFER_ROLE);
      if (roleDTOS != null) {
  ...
  private StatusCode checkData(Ams311wReqDTO ams311wReqDTO, AccountActionType actionType) {
    boolean isCreateOrUpdate =
        actionType.equals(AccountActionType.CREATE) || actionType.equals(AccountActionType.UPDATE);
    String orgId = ams311wReqDTO.getOrgId();
    ...
    if (StringUtils.isBlank(ams311wReqDTO.getUserName()) && isCreateOrUpdate) {
      log.error("Ams311wService-checkData-發生錯誤，使用者名稱不符合格式，req:{}", ams311wReqDTO);
      return StatusCode.ACCOUNT_INVALID_NAME;
    }
    if ((StringUtils.isBlank(ams311wReqDTO.getUserTypeId())
            || UserTypeIdType.toUserTypeIdType(ams311wReqDTO.getUserTypeId()) == null)
        && isCreateOrUpdate) {
      log.error("Ams311wService-checkData-發生錯誤，帳號類型不符合規範，req:{}", ams311wReqDTO);
      return StatusCode.ACCOUNT_INVALID_USER_TYPE_ID;
    }
    if (isCreateOrUpdate
        && (StringUtils.isBlank(ams311wReqDTO.getTel()) || ams311wReqDTO.getTel().length() > 100)) {
      log.error("Ams311wService-checkData-發生錯誤，聯絡電話不符合格式，req:{}", ams311wReqDTO);
      return StatusCode.ACCOUNT_INVALID_PHONE;
    }
    if ((StringUtils.isBlank(orgId) || OrgType.DEFAULT_ORG.getCode().equals(orgId))
        && isCreateOrUpdate) {
      log.error("Ams311wService-checkData-發生錯誤，組織欄位不符合格式，req:{}", ams311wReqDTO);
      return StatusCode.ACCOUNT_INVALID_ORG_ID;
    }
    if (actionType.equals(AccountActionType.CREATE)) {
      if ((StringUtils.isBlank(ams311wReqDTO.getLogin())
          || !this.isValidEmail(ams311wReqDTO.getLogin().toLowerCase()))) {
        log.error("Ams311wService-checkData-發生錯誤，帳號(信箱)格式有誤，req:{}", ams311wReqDTO);
  ...
  /** 設定查詢條件。 */
  private ExtendedUserCriteria setCriteriaFromSearch(
      boolean isAdminRole, Ams311wReqDTO ams311wReqDTO, JwtUserDTO jwtUserDTO) {
    ExtendedUserCriteria extendedUserCriteria = new ExtendedUserCriteria();
    if (StringUtils.isNotBlank(ams311wReqDTO.getLogin())) {
      extendedUserCriteria.setUserId(
          StringFilterUtils.toContainStringFilter(ams311wReqDTO.getLogin().toLowerCase().trim()));
    }
    if (StringUtils.isNotBlank(ams311wReqDTO.getUserName())) {
      extendedUserCriteria.setUserName(
          StringFilterUtils.toContainStringFilter(ams311wReqDTO.getUserName().trim()));
    }
    if (!isAdminRole) {
    ...
    if (beginDate != null && endDate != null) {
      if (endDate.isAfter(beginDate)) {
        extendedUserCriteria.setCreateTime(
            InstantFilterUtils.toInstantFilterBetween("createTime", beginDate, endDate));
      } else {
    ...
    log.info(
        "Ams311wService-setCriteriaFromSearch 查詢條件 extendedUserCriteria={}", extendedUserCriteria);

    return extendedUserCriteria;
  }

  /** 發送帳號啟用信、密碼重置信、未激活帳號刪除通知信by帳號管理頁面。 */
  public StatusCode doSendMail(
      User user,
    ...
    try {
      ...
      if (!StatusCode.SUCCESS.getCode().equals(criteriaResult.getStatusCode().getCode())) {
        log.error(
            "Ams311wService-doSendMail，寄送mail失敗，msg:{}", criteriaResult.getStatusCode().getMsg());
      ...
      // 確認mailContent。
      String message =
          this.changeKeyWordForMessage(
              mailAction,
              mailTemplateDTO.getMessage(),
              user,
              extendedUser,
              accessToken,
              otpCode,
      ...
      if (message == null) {
        log.error(
            "Ams311wService-doSendMail，寄送mail失敗，msg:{}", StatusCode.MAIL_CONTENT_ERROR.getMsg());
        return StatusCode.MAIL_CONTENT_ERROR;
      }

      // 將寄信的參數帶入NotifyUtils。
      try {
        NotifyUtils.MailBuilder mail =
            NotifyUtils.mail()
  ...
  public Ams311wMailResultDTO queryMailTemplateByCriteria(MailAction mailAction) {
    ...
    criteria.setRecipientRole(
        StringFilterUtils.toEqualStringFilter(mailAction.getRecipient_role()));
    ...
    if (templateDTOList == null || templateDTOList.isEmpty()) {
      log.error(
          "Ams311wService-queryMailTemplateByCriteria，發生錯誤，mailTemplate不存在，criteria:{}", criteria);
  ...
  private String changeKeyWordForMessage(
    ...
    if (MailAction.ACCOUNT_CREATE.getMailType().equals(mailAction.getMailType())) {
      ...
      String expiryTime =
          DateUtils.convertZone(
              createdDate, ZoneId.of("UTC"), ZoneId.of("Asia/Taipei"), "[yyyy-MM-dd HH:mm]");
    ...
    } else if (MailAction.ACCOUNT_RESET_BWD.getMailType().equals(mailAction.getMailType())
      ...
      updatedContent =
          content
              ...
              .replace("@baseURL", this.baseURL)
              .replace("@rest", user.getResetKey());
    } else if (MailAction.ACCOUNT_NOT_ACTIVATED_DELETE
        .getMailType()
        .equals(mailAction.getMailType())) {
      updatedContent = content.replace("@userName", safeHtml(extendedUser.getUserName()));
    } else if (MailAction.ACCOUNT_RESET_ACCESS_TOKEN
        .getMailType()
        .equals(mailAction.getMailType())) {
      updatedContent =
          content
  ...
  /** 驗證帳號啟用key、重置key。 */
  public Ams311wValidateIdentifierResultDTO validateIdentifier(
      Ams311wValidateIdentifierReqDTO reqDTO) {
    Ams311wValidateIdentifierResultDTO ams311wValidateIdentifierResultDTO =
        new Ams311wValidateIdentifierResultDTO();
    if (!StringUtils.isNotBlank(reqDTO.getActivationKey())
        || !StringUtils.isNotBlank(reqDTO.getResetKey())) {
      log.warn(
          "Ams311wService-validateIdentifier-發生錯誤,驗證金鑰不得無值，ActivationKey:{}，ResetKey:{}",
    ...
    Optional<User> optionalUser =
        this.customUserRepository.findOneByActivationKeyAndResetKey(
    ...
    if (optionalUser.isPresent()) {
      ...
      if (this.isOnTime(user)) {
        Optional<ExtendedUser> extendedUserOp =
            extendedUserRepository.findOneByUserId(user.getLogin());
        if (extendedUserOp.isEmpty()) {
          log.info(
              "Ams311wService-validateIdentifier Extended User table 找不到該筆資料 loginId={}",
              user.getLogin());
        ...
        Ams311wValidateIdentifierResDTO ams311wValidateIdentifierResDTO =
            new Ams311wValidateIdentifierResDTO();
        ...
        ams311wValidateIdentifierResultDTO.setAms311wValidateIdentifierResDTO(
            ams311wValidateIdentifierResDTO);
      ...
      log.warn(
          "Ams311wService-validateIdentifier-發生錯誤,驗證金鑰不通過，ActivationKey:{}，ResetKey:{}",
          reqDTO.getActivationKey(),
          reqDTO.getResetKey());
      ams311wValidateIdentifierResultDTO.setStatusCode(StatusCode.ACCOUNT_VALIDATE_KEY_FAIL);
    }
  ...
  /** 帳號啟用。 */
  public StatusCode finishActivateAccount(Ams311wActivateReqDTO reqDTO)
    ...
    if (StatusCode.SUCCESS.getCode().equals(result.getCode())) {
      ...
      if (extendedUser != null) {
        ...
        userOptional.ifPresent(
            user -> this.saveAccountLog(userOptional.get(), extendedUser, LogType.MOD));
        return StatusCode.SUCCESS;
      }
    } else {
      return result;
  ...
  public Set<String> getSideLink(String userLogin) {
    ...
    for (RoleDTO roleDTO : roleDTOList) {
      List<ResDTO> resDTOList =
          relService.roleAction(roleDTO, null, AuthorityAction.ROLE_SEARCH_RES);
  ...
  public Ams311wCurrentUserResultDTO queryPersonalInfo(String userId) {
    ...
    try {
      ...
      // 整理資料, 回傳當前登入使用者資料
      ExtendedUserDTO extendedUserDTO = extendedUserMapper.toDto(extendedUserOp.get());
      Ams311wCurrentUserResDTO ams311wCurrentUserResDTO =
          this.toCurrentUserDTO(extendedUserDTO, orgDTO);
      ...
      log.error(
          "Ams311wService-queryPersonalInfo 發生錯誤, 錯誤原因為={}", ExceptionUtils.getStackTrace(ex));
      return null;
    }
  }
   ...
   * @return
   */
  public Ams311wCurrentUserResultDTO profileSettings(
      Ams311wCurrentUserReqDTO ams311wCurrentUserReqDTO) {
    try {
      Ams311wCurrentUserResultDTO ams311wCurrentUserResultDTO = new Ams311wCurrentUserResultDTO();
  ...
  public StatusCode deleteAccount(Ams311wReqDTO ams311wReqDTO) {
    ...
    if (optionalUser.isEmpty()) {
      log.error(
          "[{}-deleteAccount]，{}", ENTITY_NAME, StatusCode.ACCOUNT_DELETE_USER_NOT_EXISTS.getMsg());
      return StatusCode.ACCOUNT_DELETE_USER_NOT_EXISTS;
    }
    User user = optionalUser.get();

    // 刪除REL關聯
    this.customRelService.accountAction(
        user, new ArrayList<>(), AuthorityAction.ACCOUNT_DELETE_ROLE);

    // 紀錄帳號異動、刪除ExtendedUser
    Optional<ExtendedUserDTO> optionalExtendedUserDTO =
        this.customExtendedUserService.findOneByUserId(user.getLogin());
    optionalExtendedUserDTO.ifPresent(
        extendedUserDTO -> {
    ...
    List<BwdHistoryDTO> bwdHistoryDTOList =
        this.customBwdHistoryQueryService.findByCriteria(bwdHistoryCriteria);
    ...
    List<LoginCountDTO> loginCountDTOList =
        this.customLoginCountQueryService.findByCriteria(loginCountCriteria);
  ...
  public void removeNotActivatedUsers() {
    if (switchRemoveNotActivatedUsers) {
      ...
      if (!usersToDelete.isEmpty()) {
        // 記錄總數
        log.info(
            "[CustomUserService-removeNotActivatedUsers]，尋找到超過三天未激活的帳號需要刪除，數量為:{}。",
            usersToDelete.size());
        ...
        usersToDelete.forEach(
            user -> {
              ...
              Optional<ExtendedUser> optionalExtendedUser =
                  customExtendedUserRepository.findOneByUserId(user.getLogin());
              if (optionalExtendedUser.isPresent()) {
                customExtendedUserRepository.deleteByUserId(user.getLogin());
                this.doSendMail(
                    user,
                    optionalExtendedUser.get(),
                    AccountActionType.DELETE_ACCOUNT,
                    null,
                    null,
                    null);
                log.info(
                    "[CustomUserService-removeNotActivatedUsers]，使用者帳號超過三天未激活，刪除使用者帳戶:{}",
                    user.getLogin());
              }
              // 刪除REL關聯
              this.customRelService.accountAction(
  ...
  public StatusCode reSendActivationEmail(Long id, String userLogin) {
    ...
    Optional<ExtendedUser> optionalExtendedUser =
        this.customExtendedUserRepository.findOneByUserId(login);
    Optional<AccessToken> optionalAccessToken =
        customAccessTokenRepository.findFirstByOwnerOrderByCreateTimeDesc(login);
    ...
    if ((StringUtils.isBlank(user.getActivationKey()))
        || (StringUtils.isBlank(user.getResetKey()))) {
      log.error(
    ...
    this.doSendMail(
        save, extendedUser, AccountActionType.CREATE, accessToken.getAccessToken(), null, null);
  ...
  public Ams311wResultDTO resetAccessToken(String login) {
    ...
    if (optionalAccessToken.isPresent()) {
      ...
      accessTokenEntity.setCreateTime(this.getCurrentTimeInTaiwan());
      ...
      Optional<ExtendedUser> extendedUserOpt =
          this.customExtendedUserRepository.findOneByUserId(login);
      ...
      StatusCode mailResult =
          this.doSendMail(
              null, extendedUser, AccountActionType.RESET_ACCESS_TOKEN, accessToken, null, null);
      if (!StatusCode.SUCCESS.getCode().equals(mailResult.getCode())) {
        return new Ams311wResultDTO(mailResult);
      }
      // 新增帳號異動紀錄
  ...
  public void generateOtp(GenerateOtpReqDTO request) {
    ...
    Optional<ExtendedUser> extendedUserOpt =
        this.customExtendedUserRepository.findOneByUserId(email);
    if (extendedUserOpt.isEmpty()) {
      throw new RuntimeException("請檢查帳號是否正確");
    }
    ExtendedUser extendedUser = extendedUserOpt.get();
    ...
    if (!StringUtils.equalsIgnoreCase(admin, otpVerify.getEmail())) {
      this.doSendMail(
          user, extendedUser, AccountActionType.VERIFY_OTP, null, otpCode, otpExpireMinute);
    }
  }
  ...
  public void verifyOtpIsPass(String email) {
    ...
    customOtpVerifyRepository
        .findByEmailAndIsPassTrue(email)
        .orElseThrow(() -> new RuntimeException("帳號(電子郵件)驗證失敗，請完成驗證後再登入"));
  }
  ...
  private ExtendedUser activateUserAccount(Ams311wActivateReqDTO reqDTO)
      throws NoSuchAlgorithmException, InvalidKeySpecException {
    Optional<User> optionalUser =
        this.customUserRepository.findOneByActivationKeyAndResetKey(
            reqDTO.getActivationKey(), reqDTO.getResetKey());
    if (optionalUser.isPresent()) {
      ...
      if (optionalExtendedUser.isPresent()) {
        String newBwd =
            RSAUtils.privateDecrypt(reqDTO.getNewBwd(), RSAUtils.getPrivateKey(this.privateKey));
        ...
        ExtendedUser saveExtendedUserResult =
            this.extendedUserRepository.save(optionalExtendedUser.get());

        log.info(
            "Ams311wService-activateUserAccount,帳號啟用已成功，userLogin:{}。",
            saveExtendedUserResult.getUserId());
      ...
      log.error(
          "Ams311wService-finishActivateAccount-發生錯誤，UserId查詢不到extendedUser，optionalUser:{}",
          optionalUser);
      return null;
    }
  }
  ...
  /** 驗證帳號啟用時設定的登入密碼。 */
  private StatusCode checkDataToActivate(Ams311wActivateReqDTO reqDTO)
      throws NoSuchAlgorithmException, InvalidKeySpecException {
    Optional<User> optionalUser =
        this.customUserRepository.findOneByActivationKeyAndResetKey(
            reqDTO.getActivationKey(), reqDTO.getResetKey());
  ...
  private void saveAccountLog(User user, ExtendedUser extendedUser, LogType logType) {
    log.info("Ams311wService-saveAccountLog 開始紀錄帳號{}異動 LogType={}", logType.getName(), logType);

    ExtendedUserLogDTO extendedUserLogDTO =
        this.toExtendedUserLogDTO(user, extendedUser, logType.getCode());
    extendedUserLogService.save(extendedUserLogDTO);

    log.info("Ams311wService-saveAccountLog 帳號{}異動紀錄完成 LogType={}", logType.getName(), logType);
  }

  private ExtendedUserLogDTO toExtendedUserLogDTO(
      User user, ExtendedUser extendedUser, String logTypeCode) {
  ...
  private Ams311wCurrentUserResDTO toCurrentUserDTO(
      ExtendedUserDTO extendedUserDTO, OrgDTO orgDTO) {
  ...
  private StatusCode checkCurrentUserUpdateData(Ams311wCurrentUserReqDTO ams311wCurrentUserReqDTO) {
    ...
    if (StringUtils.isEmpty(ams311wCurrentUserReqDTO.getUserName())) {
      log.info(
          "Ams311wService-checkCurrentUserUpdateData 姓名為必填欄位 UserName={}",
          ams311wCurrentUserReqDTO.getUserName());
    ...
    if (StringUtils.isEmpty(ams311wCurrentUserReqDTO.getTel())) {
      log.info(
          "Ams311wService-checkCurrentUserUpdateData 聯絡電話為必填欄位 Tel={}",
          ams311wCurrentUserReqDTO.getTel());
      return StatusCode.REQUEST_MISSING_REQUIRED_PARAM;
    }
