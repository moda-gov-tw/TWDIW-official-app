...
public interface CustomVCItemRepository extends VCItemRepository {
  ...
  List<VCItem> findBySerialNoAndBusinessIdAndIsTempAndTypeIn(
      String serialNo, String businessId, boolean isTemp, List<String> type);
  ...
  @Query(
      value =
          "select it.* from vc_manager.vc_item it "
