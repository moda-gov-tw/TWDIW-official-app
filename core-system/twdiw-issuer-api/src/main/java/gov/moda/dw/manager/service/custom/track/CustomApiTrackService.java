...
public class CustomApiTrackService extends TrackService {
  ...
  public CustomApiTrackService(
      ApiTrackService apiTrackService, AccessTokenQueryService accessTokenQueryService) {
   ...
   */
  public void saveApiTrack(Object[] args, ResponseDTO<?> res, String resType, long rtt)
      throws Exception {
    ...
    apiTrackDTO.setRequestParam(
        StringTrimUtils.limit1000Size(JsonUtils.toJson(req.getParameterMap())));
