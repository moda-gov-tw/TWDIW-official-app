...
public class CustomOrgService {
    ...
    private String getDidOrgId() {
        try {
            ...
            ResponseEntity<FindIssuerResDTO> response = restTemplate.exchange(url, HttpMethod.GET, entity,
    ...
    public StatusCode createOrg(OrgReqDTO orgReqDTO) {
        ...
        try {
            ...
            // 開始新增組織
            if (orgReqDTO.getVcDataSource() == null)
    ...
    public List<OrgTitleResDTO> getOrgList() {
        ...
        if (checkIsPrivilegedAccount(SecurityUtils.getJwtUserObject().get(0).getUserId())) {
            ...
            Optional<Org> org = orgRepository
                    .findByOrgIdOrderByOrgId(SecurityUtils.getJwtUserObject().get(0).getOrgId());
            if (org.isPresent()) {
