...
public class ResLogDTO implements Serializable {
  ...
  @NotNull
  @Schema(description = "功能建立時間", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof ResLogDTO)) {
      return false;
    }

    ResLogDTO resLogDTO = (ResLogDTO) o;
    if (this.id == null) {
      return false;
    }
    return Objects.equals(this.id, resLogDTO.id);
  }
