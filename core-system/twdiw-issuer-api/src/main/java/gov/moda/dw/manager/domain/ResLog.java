...
public class ResLog implements Serializable {
  ...
  public ResLog actor(String actor) {
    this.setActor(actor);
    return this;
  }
  ...
  public ResLog logType(String logType) {
  ...
  public ResLog logTime(Instant logTime) {
  ...
  public ResLog typeId(String typeId) {
  ...
  public ResLog resId(String resId) {
    this.setResId(resId);
    return this;
  }
  ...
  public ResLog resGrp(String resGrp) {
  ...
  public ResLog resName(String resName) {
  ...
  public ResLog description(String description) {
  ...
  public ResLog state(String state) {
    this.setState(state);
    return this;
  }
  ...
  public ResLog apiUri(String apiUri) {
  ...
  public ResLog webUrl(String webUrl) {
  ...
  public ResLog dataRole1(String dataRole1) {
  ...
  public ResLog dataRole2(String dataRole2) {
  ...
  public ResLog createTime(Instant createTime) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof ResLog)) {
      return false;
    }
    return getId() != null && getId().equals(((ResLog) o).getId());
  }
