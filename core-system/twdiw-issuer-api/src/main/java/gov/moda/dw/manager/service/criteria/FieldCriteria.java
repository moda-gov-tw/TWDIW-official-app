...
/**
 * Criteria class for the {@link gov.moda.dw.manager.domain.Field} entity. This class is used in
 * {@link DwSandBoxVC101WResource} to receive all the possible filtering options from the Http GET
 * request parameters. For example the following could be a valid request: {@code
 * /fields?id.greaterThan=5&attr1.contains=something&attr2.specified=false} As Spring is unable to
