...
/**
 * Criteria class for the {@link gov.moda.dw.manager.domain.Org} entity. This class is used in
 * {@link gov.moda.dw.manager.web.rest.OrgResource} to receive all the possible filtering options
 * from the Http GET request parameters. For example the following could be a valid request: {@code
 * /orgs?id.greaterThan=5&attr1.contains=something&attr2.specified=false} As Spring is unable to
...
public class OrgCriteria implements Serializable, Criteria {
  ...
  public int hashCode() {
    return Objects.hash(
        id, orgId, orgTwName, orgEnName, createTime, updateTime, vcDataSource, distinct);
  }
