...
public class InvoiceDTO implements Serializable {
  ...
  public String toString() {
    return "InvoiceDTO{"
        ...
        + getEcpayInvoiceNo()
        + "'"
        + ", ecpayInvoiceRelateNumber='"
        + getEcpayInvoiceRelateNumber()
        + "'"
        + ", orderCaseId='"
        + getOrderCaseId()
        + "'"
        ...
        + getStatus()
        + "'"
        + ", isUnderManualProcessing='"
        + getIsUnderManualProcessing()
        + "'"
        + ", orderType='"
        + getOrderType()
        + "'"
        ...
        + "'"
        + ", ecpayRandomNumber='"
        + getEcpayRandomNumber()
        + "'"
        + ", ecpayInvoiceCancelReason='"
        + getEcpayInvoiceCancelReason()
        + "'"
        + ", modifyTime='"
        + getModifyTime()
        + "'"
