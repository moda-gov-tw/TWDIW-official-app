...
public class RestResourceAop {
  ...
  @Autowired private CustomApiTrackService customApiTrackService;

  @Autowired private CustomWebTrackService customWebTrackService;

  @Autowired private AmsAuthenticationProvider amsAuthenticationProvider;
  ...
  public Object aroundForApi(ProceedingJoinPoint joinPoint) throws Throwable {
    ...
    String simpleClassName =
        joinPoint.getSignature().getDeclaringType().getSimpleName().replace("Resource", "");
  ...
  public Object aroundForWeb(ProceedingJoinPoint joinPoint) throws Throwable {
    ...
    customWebTrackService.saveWebTrack(
        joinPoint.getArgs(),
        responseDTO,
        ResType.WEB.getCode(),
        System.currentTimeMillis() - startTime);
