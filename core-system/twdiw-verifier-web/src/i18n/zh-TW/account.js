export default {
  ...
  account: {
    ...
    accountRole: "帳號角色",
    valid: {
      notLessThan: "不得少於 10 碼",
      notGreaterThan: "不得大於 20 碼",
    ...
    message: {
      actionAccount: "請確定是否要{action}帳號「 {input} 」?",
      resetBwd: "請確定是否要重置密碼「 {input} 」?",
      deleteAccount: "請確定是否要刪除帳號「 {input} 」?",
      resendActivationEmail: "請確定是否要重新寄送啟用信「 {input} 」?"
    }
  },
  activate: {
    title: "【數位憑證皮夾】驗證端模組系統_重設您的密碼",
    newPwdTip: "請輸入您的新密碼",
    newPwd: "新密碼",
