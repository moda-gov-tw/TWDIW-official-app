            ...
            >
              <template #append>
                ...
                <q-btn
                  ...
                  :aria-label="
                    showPasswordChangeNew
                      ? t('ams302w.button.true')
                      : t('ams302w.button.false')
                  "
                />
    ...
    .catch((error) => {
      if (error.response?.data?.message) {
        ...
        if (message.includes(t("ams302w.error.repeat"))) {
          ...
          $d.alert(t("pleaseConfirm"), message);
        }
        isOpenPwdReset.value = true;
      }
    });
