            ...
            >
              <template v-slot:body-cell-name="props">
                <q-td :props="props">
                  ...
                  <p
                    v-if="
                      getLabelName(props.row.name) === t('org.table.orgId') ||
                      getLabelName(props.row.name) === t('org.table.orgEnName')
                    "
                    style="font-size: 16px; color: #d33e5f"
                  >
                    {{ t("org.notice.canNotEdit") }}
                  </p>
                </q-td>
              </template>
              ...
              <template v-slot:body-cell-value="props">
                <q-td :props="props">
                  <q-input
                    ...
                    v-if="getLabelName(props.row.name) === t('org.table.orgId')"
                  />
                  <q-input
                    outlined
                    class="col"
