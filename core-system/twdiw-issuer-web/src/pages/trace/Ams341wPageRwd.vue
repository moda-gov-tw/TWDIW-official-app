                      ...
                      <div class="row q-col-gutter-md q-mb-md">
                        ...
                        <div class="col-12 col-md-6">
                          <q-select
                            ...
                            :options="[
                              {
                                label: t('trace.statusCode.success'),
                                value: 'success'
                              },
                              {
                                label: t('trace.statusCode.fail'),
                                value: 'fail'
                              }
                            ]"
                            outlined
...
const submitSearch = async () => {
  ...
  if (isValid) {
    ...
    } else if (["success", "fail"].includes(statusCode)) {
      searchQuery.value = t(
        `trace.statusCodeMsg.${searchForm.value.statusCode?.value}`
      );
    } else if (searchForm.value.beginDate && searchForm.value.endDate) {
      searchQuery.value = t("trace.rangeTime");
    } else {
