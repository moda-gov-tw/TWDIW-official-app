...
public class ExceptionTrackService extends TrackService {
  ...
  public ExceptionTrackService(
      ApiTrackService apiTrackService, CustomResQueryService customResQueryService) {
   ...
   */
  public void saveHttpExceptionTrack(String args, ProblemDetailWithCause problem, long rtt)
      throws Exception {
    log.info(
        "ExceptionTrackService-saveHttpExceptionTrack，儲存ApiTrack，ProblemDetailWithCause:{}",
        problem);
    ...
    apiTrackDTO.setAccessToken1(
        StringTrimUtils.limit200Size(req.getHeader(AccessTokenFilter.ACCESS_TOKEN_HEADER)));
    ...
    apiTrackDTO.setRequestParam(
        StringTrimUtils.limit2000Size(JsonUtils.toJson(req.getParameterMap())));
