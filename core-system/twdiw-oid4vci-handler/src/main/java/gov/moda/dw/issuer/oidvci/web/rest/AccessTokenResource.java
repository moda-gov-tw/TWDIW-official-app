...
public class AccessTokenResource {
   ...
   */
  //  @PostMapping("")
  //  public ResponseEntity<AccessTokenDTO> createAccessToken(@Valid @RequestBody AccessTokenDTO
  // accessTokenDTO) throws URISyntaxException {
  //    log.debug("REST request to save AccessToken : {}", accessTokenDTO);
  //    if (accessTokenDTO.getId() != null) {
  //      throw new BadRequestAlertException("A new accessToken cannot already have an ID",
  ...
  //  ) throws URISyntaxException {
  //    log.debug("REST request to partial update AccessToken partially : {}, {}", id,
  // accessTokenDTO);
  //    if (accessTokenDTO.getId() == null) {
  //      throw new BadRequestAlertException("Invalid id", ENTITY_NAME, "idnull");
  //    }
