...
數位發展部公開行動端數位憑證皮夾相關原始碼，期望透過公私協力推動以 OID4VC / OID4VP 為核心的可信賴身份服務。本文件提供專案概況、元件架構與合規事項，並說明各子專案閱讀路徑，協助開發者依循統一標準進行開發與貢獻。
...
- **是否可整合既有服務？**  
  如服務端支援 OID4VC / OID4VP，即可透過 APPSDK 串接持有者、發證端與驗證端流程。
