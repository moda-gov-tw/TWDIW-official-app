...
import tw.gov.moda.diw.databinding.FragmentVerifiablePresentationContractBinding

@AndroidEntryPoint
class VerifiablePresentationContractFragment : BaseFragment<FragmentVerifiablePresentationContractBinding>() {

    companion object {
        fun newInstance() = VerifiablePresentationContractFragment()

        private const val DIALOG_WEB_ERROR = "DIALOG_WEB_ERROR"
    }

    private val mViewModel: VerifiablePresentationContractViewModel by viewModels()

    private val mActivityViewModel: MainViewModel by activityViewModels<MainViewModel>()

    override fun initViewBinding(container: ViewGroup?): FragmentVerifiablePresentationContractBinding {
        return FragmentVerifiablePresentationContractBinding.inflate(layoutInflater, container, false)
    }
    ...
    override fun initView() {
        ...
        binding.webView.webViewClient = object : WebViewClient() {
            override fun onPageFinished(view: WebView?, url: String?) {
                ...
                if (this@VerifiablePresentationContractFragment.isVisible && activity?.isFinishing == false && mProgressDialogWhite?.isShowing == true) {
