//
//  AddCertificateSuccessViewController.swift
//  DigitalWallet
//

import UIKit

class AddCertificateSuccessViewController: BaseViewController {
    ...
    init(applyVCData: ApplyVCDataResponse, orgName: String, cardImageData: Data?, displayName: String, verifiableCredentailResult: VerifiableCredentailResult?) {
        ...
        super.init(nibName: "AddCertificateSuccessViewController", bundle: nil)
    }
